...
namespace UnitsNet
{
    ...
    internal static partial class Quantity
    {
        ...
        internal static bool TryParse([CanBeNull] IFormatProvider formatProvider, Type quantityType, string quantityString, out IQuantity quantity)
        {
            ...
            if (quantityType == typeof(ElectricLinearResistivity))
                return parser.TryParse<ElectricLinearResistivity, ElectricLinearResistivityUnit>(quantityString, formatProvider, ElectricLinearResistivity.From, out quantity);
