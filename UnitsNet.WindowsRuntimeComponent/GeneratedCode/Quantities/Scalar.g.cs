...
namespace UnitsNet
{
    ...
    public sealed partial class Scalar : IQuantity
    {
        /// <summary>
        ...
        /// <summary>
        ///     Creates the quantity with a value of 0 in the base unit Amount.
        /// </summary>
        /// <remarks>
        ...
        private Scalar(QuantityValue value, ScalarUnit unit)
        {
        ...
        public static string GetAbbreviation(ScalarUnit unit, [CanBeNull] string cultureName)
        {
        ...
        /// </exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static Scalar Parse(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        ///     Length.Parse("5.5 m", new CultureInfo("en-US"));
        /// </example>
        public static bool TryParse([CanBeNull] string str, out Scalar result)
        {
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParse([CanBeNull] string str, [CanBeNull] string cultureName, out Scalar result)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static ScalarUnit ParseUnit(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParseUnit(string str, [CanBeNull] string cultureName, out ScalarUnit unit)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        internal int CompareTo(Scalar other)
        {
        ...
        double IQuantity.As(object unit) => As((ScalarUnit)unit);
        ...
        private QuantityValue AsBaseNumericType(ScalarUnit unit)
        {
            if (Unit == unit)
                return _value;
