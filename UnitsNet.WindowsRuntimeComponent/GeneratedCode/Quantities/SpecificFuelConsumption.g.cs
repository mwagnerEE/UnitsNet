...
namespace UnitsNet
{
    ...
    public sealed partial class SpecificFuelConsumption : IQuantity
    {
        ...
        private SpecificFuelConsumption(QuantityValue value, SpecificFuelConsumptionUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(SpecificFuelConsumptionUnit unit)
        {
            if (Unit == unit)
                return _value;
