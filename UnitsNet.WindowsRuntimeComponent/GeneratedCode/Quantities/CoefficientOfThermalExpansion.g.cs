...
namespace UnitsNet
{
    ...
    public sealed partial class CoefficientOfThermalExpansion : IQuantity
    {
        ...
        private CoefficientOfThermalExpansion(QuantityValue value, CoefficientOfThermalExpansionUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(CoefficientOfThermalExpansionUnit unit)
        {
            if (Unit == unit)
                return _value;
