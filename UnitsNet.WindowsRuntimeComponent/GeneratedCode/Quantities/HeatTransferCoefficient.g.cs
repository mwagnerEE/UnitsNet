...
namespace UnitsNet
{
    ...
    public sealed partial class HeatTransferCoefficient : IQuantity
    {
        ...
        private HeatTransferCoefficient(QuantityValue value, HeatTransferCoefficientUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(HeatTransferCoefficientUnit unit)
        {
            if (Unit == unit)
                return _value;
