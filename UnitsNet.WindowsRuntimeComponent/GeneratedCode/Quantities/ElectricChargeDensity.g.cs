...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricChargeDensity : IQuantity
    {
        ...
        private ElectricChargeDensity(QuantityValue value, ElectricChargeDensityUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(ElectricChargeDensityUnit unit)
        {
            if (Unit == unit)
                return _value;
