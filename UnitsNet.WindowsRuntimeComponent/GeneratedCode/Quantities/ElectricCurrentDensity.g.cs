...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricCurrentDensity : IQuantity
    {
        ...
        private ElectricCurrentDensity(QuantityValue value, ElectricCurrentDensityUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(ElectricCurrentDensityUnit unit)
        {
            if (Unit == unit)
                return _value;
