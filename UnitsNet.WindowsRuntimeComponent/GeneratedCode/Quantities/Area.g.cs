...
namespace UnitsNet
{
    ...
    public sealed partial class Area : IQuantity
    {
        ...
        private Area(QuantityValue value, AreaUnit unit)
        {
        ...
        /// </summary>
        public double KilocircularMils => As(AreaUnit.KilocircularMil);
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Area FromAWG(double awg)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Area FromCircularMils(double circularmils)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Area FromKilocircularMils(double kilocircularmils)
        {
        ...
        private QuantityValue AsBaseUnit()
        {
            switch(Unit)
            {
                ...
                case AreaUnit.AWG: return 1.2668E-8 * Math.Pow(92, (36 - _value) / 39);
                case AreaUnit.CircularMil: return _value * 5.067e-10;
                case AreaUnit.Hectare: return _value * 1e4;
                case AreaUnit.KilocircularMil: return _value * 5.067e-7;
        ...
        private QuantityValue AsBaseNumericType(AreaUnit unit)
        {
            if (Unit == unit)
                return _value;
            ...
            switch(unit)
            {
                ...
                case AreaUnit.AWG: return 36 - (39 * Math.Log(baseUnitValue / 1.2668E-8, 92));
                case AreaUnit.CircularMil: return baseUnitValue / 5.067e-10;
                case AreaUnit.Hectare: return baseUnitValue / 1e4;
                case AreaUnit.KilocircularMil: return baseUnitValue / 5.067e-7;
