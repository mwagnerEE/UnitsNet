...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricPotentialChangeRate : IQuantity
    {
        ...
        private ElectricPotentialChangeRate(QuantityValue value, ElectricPotentialChangeRateUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(ElectricPotentialChangeRateUnit unit)
        {
            if (Unit == unit)
                return _value;
