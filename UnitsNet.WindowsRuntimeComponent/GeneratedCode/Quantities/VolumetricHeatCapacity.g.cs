...
namespace UnitsNet
{
    ...
    public sealed partial class VolumetricHeatCapacity : IQuantity
    {
        ...
        private VolumetricHeatCapacity(QuantityValue value, VolumetricHeatCapacityUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(VolumetricHeatCapacityUnit unit)
        {
            if (Unit == unit)
                return _value;
