...
namespace UnitsNet
{
    ...
    public sealed partial class BrakeSpecificFuelConsumption : IQuantity
    {
        ...
        private BrakeSpecificFuelConsumption(QuantityValue value, BrakeSpecificFuelConsumptionUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(BrakeSpecificFuelConsumptionUnit unit)
        {
            if (Unit == unit)
                return _value;
