...
namespace UnitsNet
{
    ...
    public sealed partial class RotationalStiffnessPerLength : IQuantity
    {
        ...
        private RotationalStiffnessPerLength(QuantityValue value, RotationalStiffnessPerLengthUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(RotationalStiffnessPerLengthUnit unit)
        {
            if (Unit == unit)
                return _value;
