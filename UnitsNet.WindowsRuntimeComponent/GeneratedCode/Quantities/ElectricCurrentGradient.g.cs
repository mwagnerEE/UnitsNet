...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricCurrentGradient : IQuantity
    {
        ...
        private ElectricCurrentGradient(QuantityValue value, ElectricCurrentGradientUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(ElectricCurrentGradientUnit unit)
        {
            if (Unit == unit)
                return _value;
