...
namespace UnitsNet
{
    ...
    public sealed partial class WarpingMomentOfInertia : IQuantity
    {
        ...
        private WarpingMomentOfInertia(QuantityValue value, WarpingMomentOfInertiaUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(WarpingMomentOfInertiaUnit unit)
        {
            if (Unit == unit)
                return _value;
