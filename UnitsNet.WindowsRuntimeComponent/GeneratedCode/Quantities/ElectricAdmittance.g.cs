...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricAdmittance : IQuantity
    {
        ...
        private ElectricAdmittance(QuantityValue value, ElectricAdmittanceUnit unit)
        {
        ...
        /// </summary>
        public double Picosiemens => As(ElectricAdmittanceUnit.Picosiemens);
        ...
        public static ElectricAdmittance FromKilosiemens(double kilosiemens)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static ElectricAdmittance FromMegasiemens(double megasiemens)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static ElectricAdmittance FromPicosiemens(double picosiemens)
        {
        ...
        private QuantityValue AsBaseUnit()
        {
            switch(Unit)
            {
                case ElectricAdmittanceUnit.Kilosiemens: return (_value) * 1e3d;
                case ElectricAdmittanceUnit.Megasiemens: return (_value) * 1e6d;
                ...
                case ElectricAdmittanceUnit.Picosiemens: return (_value) * 1e-12d;
        ...
        private QuantityValue AsBaseNumericType(ElectricAdmittanceUnit unit)
        {
            if (Unit == unit)
                return _value;
            ...
            switch(unit)
            {
                case ElectricAdmittanceUnit.Kilosiemens: return (baseUnitValue) / 1e3d;
                case ElectricAdmittanceUnit.Megasiemens: return (baseUnitValue) / 1e6d;
                ...
                case ElectricAdmittanceUnit.Picosiemens: return (baseUnitValue) / 1e-12d;
