...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricSurfaceChargeDensity : IQuantity
    {
        ...
        private ElectricSurfaceChargeDensity(QuantityValue value, ElectricSurfaceChargeDensityUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(ElectricSurfaceChargeDensityUnit unit)
        {
            if (Unit == unit)
                return _value;
