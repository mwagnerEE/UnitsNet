...
namespace UnitsNet
{
    ...
    public sealed partial class RotationalAcceleration : IQuantity
    {
        ...
        private RotationalAcceleration(QuantityValue value, RotationalAccelerationUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(RotationalAccelerationUnit unit)
        {
            if (Unit == unit)
                return _value;
