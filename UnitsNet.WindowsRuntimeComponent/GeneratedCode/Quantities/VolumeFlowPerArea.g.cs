...
namespace UnitsNet
{
    ...
    public sealed partial class VolumeFlowPerArea : IQuantity
    {
        /// <summary>
        ...
        /// <summary>
        ///     Creates the quantity with a value of 0 in the base unit CubicMeterPerSecondPerSquareMeter.
        /// </summary>
        /// <remarks>
        ///     Windows Runtime Component requires a default constructor.
        /// </remarks>
        public VolumeFlowPerArea()
        {
            _value = 0;
            _unit = BaseUnit;
        }
        ...
        private VolumeFlowPerArea(QuantityValue value, VolumeFlowPerAreaUnit unit)
        {
        ...
        public static string GetAbbreviation(VolumeFlowPerAreaUnit unit, [CanBeNull] string cultureName)
        {
        ...
        /// </exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static VolumeFlowPerArea Parse(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        ///     Length.Parse("5.5 m", new CultureInfo("en-US"));
        /// </example>
        public static bool TryParse([CanBeNull] string str, out VolumeFlowPerArea result)
        {
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParse([CanBeNull] string str, [CanBeNull] string cultureName, out VolumeFlowPerArea result)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static VolumeFlowPerAreaUnit ParseUnit(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParseUnit(string str, [CanBeNull] string cultureName, out VolumeFlowPerAreaUnit unit)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        internal int CompareTo(VolumeFlowPerArea other)
        {
        ...
        double IQuantity.As(object unit) => As((VolumeFlowPerAreaUnit)unit);
        ...
        private QuantityValue AsBaseUnit()
        {
            switch(Unit)
            {
                case VolumeFlowPerAreaUnit.CubicFootPerMinutePerSquareFoot: return _value / 196.850394;
                case VolumeFlowPerAreaUnit.CubicMeterPerSecondPerSquareMeter: return _value;
                default:
                    throw new NotImplementedException($"Can not convert {Unit} to base units.");
            }
        }

        private QuantityValue AsBaseNumericType(VolumeFlowPerAreaUnit unit)
        {
            if (Unit == unit)
                return _value;
            ...
            switch(unit)
            {
                case VolumeFlowPerAreaUnit.CubicFootPerMinutePerSquareFoot: return baseUnitValue * 196.850394;
                case VolumeFlowPerAreaUnit.CubicMeterPerSecondPerSquareMeter: return baseUnitValue;
                default:
