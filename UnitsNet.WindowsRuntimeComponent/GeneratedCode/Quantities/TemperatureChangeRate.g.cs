...
namespace UnitsNet
{
    ...
    public sealed partial class TemperatureChangeRate : IQuantity
    {
        ...
        private TemperatureChangeRate(QuantityValue value, TemperatureChangeRateUnit unit)
        {
        ...
        private QuantityValue AsBaseNumericType(TemperatureChangeRateUnit unit)
        {
            if (Unit == unit)
                return _value;
