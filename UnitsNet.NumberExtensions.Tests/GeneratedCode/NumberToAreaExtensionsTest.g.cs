...
namespace UnitsNet.Tests
{
    public class NumberToAreaExtensionsTests
    {
        ...
        [Fact]
        public void NumberToAWGTest() =>
            Assert.Equal(Area.FromAWG(2), 2.AWG());

        [Fact]
        public void NumberToCircularMilsTest() =>
            Assert.Equal(Area.FromCircularMils(2), 2.CircularMils());
        ...
        [Fact]
        public void NumberToKilocircularMilsTest() =>
            Assert.Equal(Area.FromKilocircularMils(2), 2.KilocircularMils());
