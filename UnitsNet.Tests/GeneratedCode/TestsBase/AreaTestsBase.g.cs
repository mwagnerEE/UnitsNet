...
// ReSharper disable once PartialTypeWithSinglePart
    public abstract partial class AreaTestsBase : QuantityTestsBase
    {
        ...
        protected abstract double AWGInOneSquareMeter { get; }
        protected abstract double CircularMilsInOneSquareMeter { get; }
        protected abstract double HectaresInOneSquareMeter { get; }
        protected abstract double KilocircularMilsInOneSquareMeter { get; }
...
// ReSharper disable VirtualMemberNeverOverriden.Global
        ...
        protected virtual double AWGTolerance { get { return 1e-5; } }
        protected virtual double CircularMilsTolerance { get { return 1e-5; } }
        protected virtual double HectaresTolerance { get { return 1e-5; } }
        protected virtual double KilocircularMilsTolerance { get { return 1e-5; } }
...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        protected (double UnitsInBaseUnit, double Tolerence) GetConversionFactor(AreaUnit unit)
        {
            return unit switch
            {
                ...
                AreaUnit.AWG => (AWGInOneSquareMeter, AWGTolerance),
                AreaUnit.CircularMil => (CircularMilsInOneSquareMeter, CircularMilsTolerance),
                AreaUnit.Hectare => (HectaresInOneSquareMeter, HectaresTolerance),
                AreaUnit.KilocircularMil => (KilocircularMilsInOneSquareMeter, KilocircularMilsTolerance),
        ...
        public static IEnumerable<object[]> UnitTypes = new List<object[]>
        {
            ...
            new object[] { AreaUnit.AWG },
            new object[] { AreaUnit.CircularMil },
            new object[] { AreaUnit.Hectare },
            new object[] { AreaUnit.KilocircularMil },
        ...
        {
            Assert.Throws<ArgumentException>(() => new Area((QuantityValue)0.0, AreaUnit.Undefined));
        }
        ...
        public void SquareMeterToAreaUnits()
        {
            ...
            AssertEx.EqualTolerance(AWGInOneSquareMeter, squaremeter.AWG, AWGTolerance);
            AssertEx.EqualTolerance(CircularMilsInOneSquareMeter, squaremeter.CircularMils, CircularMilsTolerance);
            AssertEx.EqualTolerance(HectaresInOneSquareMeter, squaremeter.Hectares, HectaresTolerance);
            AssertEx.EqualTolerance(KilocircularMilsInOneSquareMeter, squaremeter.KilocircularMils, KilocircularMilsTolerance);
        ...
        public void From_ValueAndUnit_ReturnsQuantityWithSameValueAndUnit()
        {
            ...
            var quantity01 = Area.From(1, AreaUnit.AWG);
            AssertEx.EqualTolerance(1, quantity01.AWG, AWGTolerance);
            Assert.Equal(AreaUnit.AWG, quantity01.Unit);

            var quantity02 = Area.From(1, AreaUnit.CircularMil);
            AssertEx.EqualTolerance(1, quantity02.CircularMils, CircularMilsTolerance);
            Assert.Equal(AreaUnit.CircularMil, quantity02.Unit);

            var quantity03 = Area.From(1, AreaUnit.Hectare);
            AssertEx.EqualTolerance(1, quantity03.Hectares, HectaresTolerance);
            Assert.Equal(AreaUnit.Hectare, quantity03.Unit);

            var quantity04 = Area.From(1, AreaUnit.KilocircularMil);
            AssertEx.EqualTolerance(1, quantity04.KilocircularMils, KilocircularMilsTolerance);
            Assert.Equal(AreaUnit.KilocircularMil, quantity04.Unit);

            var quantity05 = Area.From(1, AreaUnit.SquareCentimeter);
            AssertEx.EqualTolerance(1, quantity05.SquareCentimeters, SquareCentimetersTolerance);
            Assert.Equal(AreaUnit.SquareCentimeter, quantity05.Unit);

            var quantity06 = Area.From(1, AreaUnit.SquareDecimeter);
            AssertEx.EqualTolerance(1, quantity06.SquareDecimeters, SquareDecimetersTolerance);
            Assert.Equal(AreaUnit.SquareDecimeter, quantity06.Unit);

            var quantity07 = Area.From(1, AreaUnit.SquareFoot);
            AssertEx.EqualTolerance(1, quantity07.SquareFeet, SquareFeetTolerance);
            Assert.Equal(AreaUnit.SquareFoot, quantity07.Unit);

            var quantity08 = Area.From(1, AreaUnit.SquareInch);
            AssertEx.EqualTolerance(1, quantity08.SquareInches, SquareInchesTolerance);
            Assert.Equal(AreaUnit.SquareInch, quantity08.Unit);

            var quantity09 = Area.From(1, AreaUnit.SquareKilometer);
            AssertEx.EqualTolerance(1, quantity09.SquareKilometers, SquareKilometersTolerance);
            Assert.Equal(AreaUnit.SquareKilometer, quantity09.Unit);

            var quantity10 = Area.From(1, AreaUnit.SquareMeter);
            AssertEx.EqualTolerance(1, quantity10.SquareMeters, SquareMetersTolerance);
            Assert.Equal(AreaUnit.SquareMeter, quantity10.Unit);

            var quantity11 = Area.From(1, AreaUnit.SquareMicrometer);
            AssertEx.EqualTolerance(1, quantity11.SquareMicrometers, SquareMicrometersTolerance);
            Assert.Equal(AreaUnit.SquareMicrometer, quantity11.Unit);

            var quantity12 = Area.From(1, AreaUnit.SquareMile);
            AssertEx.EqualTolerance(1, quantity12.SquareMiles, SquareMilesTolerance);
            Assert.Equal(AreaUnit.SquareMile, quantity12.Unit);

            var quantity13 = Area.From(1, AreaUnit.SquareMillimeter);
            AssertEx.EqualTolerance(1, quantity13.SquareMillimeters, SquareMillimetersTolerance);
            Assert.Equal(AreaUnit.SquareMillimeter, quantity13.Unit);

            var quantity14 = Area.From(1, AreaUnit.SquareNauticalMile);
            AssertEx.EqualTolerance(1, quantity14.SquareNauticalMiles, SquareNauticalMilesTolerance);
            Assert.Equal(AreaUnit.SquareNauticalMile, quantity14.Unit);

            var quantity15 = Area.From(1, AreaUnit.SquareYard);
            AssertEx.EqualTolerance(1, quantity15.SquareYards, SquareYardsTolerance);
            Assert.Equal(AreaUnit.SquareYard, quantity15.Unit);

            var quantity16 = Area.From(1, AreaUnit.UsSurveySquareFoot);
            AssertEx.EqualTolerance(1, quantity16.UsSurveySquareFeet, UsSurveySquareFeetTolerance);
            Assert.Equal(AreaUnit.UsSurveySquareFoot, quantity16.Unit);
        ...
        public void As()
        {
            ...
            AssertEx.EqualTolerance(AWGInOneSquareMeter, squaremeter.As(AreaUnit.AWG), AWGTolerance);
            AssertEx.EqualTolerance(CircularMilsInOneSquareMeter, squaremeter.As(AreaUnit.CircularMil), CircularMilsTolerance);
            AssertEx.EqualTolerance(HectaresInOneSquareMeter, squaremeter.As(AreaUnit.Hectare), HectaresTolerance);
            AssertEx.EqualTolerance(KilocircularMilsInOneSquareMeter, squaremeter.As(AreaUnit.KilocircularMil), KilocircularMilsTolerance);
        ...
        public void ConversionRoundTrip()
        {
            ...
            AssertEx.EqualTolerance(1, Area.FromAWG(squaremeter.AWG).SquareMeters, AWGTolerance);
            AssertEx.EqualTolerance(1, Area.FromCircularMils(squaremeter.CircularMils).SquareMeters, CircularMilsTolerance);
            AssertEx.EqualTolerance(1, Area.FromHectares(squaremeter.Hectares).SquareMeters, HectaresTolerance);
            AssertEx.EqualTolerance(1, Area.FromKilocircularMils(squaremeter.KilocircularMils).SquareMeters, KilocircularMilsTolerance);
...
#pragma warning restore CS8073
        ...
        public void ToString_ReturnsValueAndUnitAbbreviationInCurrentCulture()
        {
            ...
            try {
                ...
                Assert.Equal("1 AWG", new Area(1, AreaUnit.AWG).ToString());
                Assert.Equal("1 cmil", new Area(1, AreaUnit.CircularMil).ToString());
                Assert.Equal("1 ha", new Area(1, AreaUnit.Hectare).ToString());
                Assert.Equal("1 kcmil", new Area(1, AreaUnit.KilocircularMil).ToString());
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 AWG", new Area(1, AreaUnit.AWG).ToString(swedishCulture));
            Assert.Equal("1 cmil", new Area(1, AreaUnit.CircularMil).ToString(swedishCulture));
            Assert.Equal("1 ha", new Area(1, AreaUnit.Hectare).ToString(swedishCulture));
            Assert.Equal("1 kcmil", new Area(1, AreaUnit.KilocircularMil).ToString(swedishCulture));
