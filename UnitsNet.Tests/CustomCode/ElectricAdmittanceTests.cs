...
namespace UnitsNet.Tests.CustomCode
{
    public class ElectricAdmittanceTests : ElectricAdmittanceTestsBase
    {
        ...
        protected override double KilosiemensInOneSiemens => throw new NotImplementedException();

        protected override double MegasiemensInOneSiemens => throw new NotImplementedException();

        protected override double PicosiemensInOneSiemens => throw new NotImplementedException();
    }
}
