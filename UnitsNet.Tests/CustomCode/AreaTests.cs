...
namespace UnitsNet.Tests.CustomCode
{
    public class AreaTests : AreaTestsBase
    {
        ...
        protected override double CircularMilsInOneSquareMeter => 1.974E9;

        protected override double KilocircularMilsInOneSquareMeter => 1.974E6;

        protected override double AWGInOneSquareMeter => -120.8369;
