...
namespace UnitsNet.Tests.Serialization
{
    ...
    public abstract class SerializationTestsBase<TPayload>
    {
        ...
        public virtual void TupleOfDoubleAndNullQuantities_SerializationRoundTrips()
        {
            ...
            Assert.Equal(quantity.Unit, results.Item1.Unit);
            Assert.Equal(quantity.Value, results.Item1.Value);
        ...
        public virtual void TupleOfDecimalAndNullQuantities_SerializationRoundTrips()
        {
            ...
            Assert.Equal(quantity.Unit, results.Item2.Unit);
            Assert.Equal(quantity.Value, results.Item2.Value);
        ...
        //        NullableQuantity = doubleQuantity,
        ...
        //    Assert.Equal(doubleQuantity.Unit, results.NullableQuantity.Unit);
        //    Assert.Equal(doubleQuantity.Value, results.NullableQuantity.Value);
        ...
        protected class TestObject<TDoubleQuantity, TDecimalQuantity> : TestObject<TDoubleQuantity>
            where TDoubleQuantity : IQuantity
            where TDecimalQuantity : IQuantity, IDecimalQuantity
        {
            [DataMember]
