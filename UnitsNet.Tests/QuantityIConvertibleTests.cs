...
namespace UnitsNet.Tests
{
    public class QuantityIConvertibleTests
    {
        ...
        public void ToTypeTest()
        {
            ...
            // BaseDimensions
            Assert.Equal(Length.BaseDimensions, lengthAsIConvertible.ToType(typeof(Dimensions), null));
            Assert.Equal(Length.BaseDimensions, Convert.ChangeType(length, typeof(Dimensions)));
        }
