...
namespace UnitsNet.NumberExtensions.NumberToElectricAdmittance
{
    ...
    public static class NumberToElectricAdmittanceExtensions
    {
        ...
        /// <inheritdoc cref="ElectricAdmittance.FromPicosiemens(UnitsNet.QuantityValue)" />
        public static ElectricAdmittance Picosiemens<T>(this T value) =>
            ElectricAdmittance.FromPicosiemens(Convert.ToDouble(value));
