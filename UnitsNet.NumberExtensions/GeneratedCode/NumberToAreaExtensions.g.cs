...
namespace UnitsNet.NumberExtensions.NumberToArea
{
    ...
    public static class NumberToAreaExtensions
    {
        ...
        /// <inheritdoc cref="Area.FromAWG(UnitsNet.QuantityValue)" />
        public static Area AWG<T>(this T value) =>
            Area.FromAWG(Convert.ToDouble(value));

        /// <inheritdoc cref="Area.FromCircularMils(UnitsNet.QuantityValue)" />
        public static Area CircularMils<T>(this T value) =>
            Area.FromCircularMils(Convert.ToDouble(value));
        ...
        /// <inheritdoc cref="Area.FromKilocircularMils(UnitsNet.QuantityValue)" />
        public static Area KilocircularMils<T>(this T value) =>
            Area.FromKilocircularMils(Convert.ToDouble(value));
