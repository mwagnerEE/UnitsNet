...
namespace UnitsNet
{
    ...
    public struct  MagneticField
    {
        ...
        /// </summary>
        public static MagneticField MaxValue { get; } = new MagneticField(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static MagneticField MinValue { get; } = new MagneticField(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromGausses(QuantityValue gausses) => new MagneticField(gausses, MagneticFieldUnit.Gauss);

        /// <summary>
        ///     Creates a <see cref="MagneticField"/> from <see cref="MagneticFieldUnit.Microtesla"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromMicroteslas(QuantityValue microteslas) => new MagneticField(microteslas, MagneticFieldUnit.Microtesla);

        /// <summary>
        ///     Creates a <see cref="MagneticField"/> from <see cref="MagneticFieldUnit.Milligauss"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromMilligausses(QuantityValue milligausses) => new MagneticField(milligausses, MagneticFieldUnit.Milligauss);

        /// <summary>
        ///     Creates a <see cref="MagneticField"/> from <see cref="MagneticFieldUnit.Millitesla"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromMilliteslas(QuantityValue milliteslas) => new MagneticField(milliteslas, MagneticFieldUnit.Millitesla);

        /// <summary>
        ///     Creates a <see cref="MagneticField"/> from <see cref="MagneticFieldUnit.Nanotesla"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromNanoteslas(QuantityValue nanoteslas) => new MagneticField(nanoteslas, MagneticFieldUnit.Nanotesla);

        /// <summary>
        ///     Creates a <see cref="MagneticField"/> from <see cref="MagneticFieldUnit.Tesla"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromTeslas(QuantityValue teslas) => new MagneticField(teslas, MagneticFieldUnit.Tesla);
        ...
        public QuantityValue As(MagneticFieldUnit unit) => GetValueAs(unit);
