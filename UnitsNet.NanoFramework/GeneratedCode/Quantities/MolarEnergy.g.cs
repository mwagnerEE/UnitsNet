...
namespace UnitsNet
{
    ...
    public struct  MolarEnergy
    {
        ...
        /// </summary>
        public static MolarEnergy MaxValue { get; } = new MolarEnergy(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static MolarEnergy MinValue { get; } = new MolarEnergy(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MolarEnergy FromJoulesPerMole(QuantityValue joulespermole) => new MolarEnergy(joulespermole, MolarEnergyUnit.JoulePerMole);

        /// <summary>
        ///     Creates a <see cref="MolarEnergy"/> from <see cref="MolarEnergyUnit.KilojoulePerMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MolarEnergy FromKilojoulesPerMole(QuantityValue kilojoulespermole) => new MolarEnergy(kilojoulespermole, MolarEnergyUnit.KilojoulePerMole);

        /// <summary>
        ///     Creates a <see cref="MolarEnergy"/> from <see cref="MolarEnergyUnit.MegajoulePerMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MolarEnergy FromMegajoulesPerMole(QuantityValue megajoulespermole) => new MolarEnergy(megajoulespermole, MolarEnergyUnit.MegajoulePerMole);
        ...
        public QuantityValue As(MolarEnergyUnit unit) => GetValueAs(unit);
