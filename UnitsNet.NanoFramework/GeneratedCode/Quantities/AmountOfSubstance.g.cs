...
namespace UnitsNet
{
    ...
    public struct  AmountOfSubstance
    {
        ...
        /// </summary>
        public static AmountOfSubstance MaxValue { get; } = new AmountOfSubstance(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static AmountOfSubstance MinValue { get; } = new AmountOfSubstance(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromCentimoles(QuantityValue centimoles) => new AmountOfSubstance(centimoles, AmountOfSubstanceUnit.Centimole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.CentipoundMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromCentipoundMoles(QuantityValue centipoundmoles) => new AmountOfSubstance(centipoundmoles, AmountOfSubstanceUnit.CentipoundMole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.Decimole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromDecimoles(QuantityValue decimoles) => new AmountOfSubstance(decimoles, AmountOfSubstanceUnit.Decimole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.DecipoundMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromDecipoundMoles(QuantityValue decipoundmoles) => new AmountOfSubstance(decipoundmoles, AmountOfSubstanceUnit.DecipoundMole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.Kilomole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromKilomoles(QuantityValue kilomoles) => new AmountOfSubstance(kilomoles, AmountOfSubstanceUnit.Kilomole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.KilopoundMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromKilopoundMoles(QuantityValue kilopoundmoles) => new AmountOfSubstance(kilopoundmoles, AmountOfSubstanceUnit.KilopoundMole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.Megamole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromMegamoles(QuantityValue megamoles) => new AmountOfSubstance(megamoles, AmountOfSubstanceUnit.Megamole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.Micromole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromMicromoles(QuantityValue micromoles) => new AmountOfSubstance(micromoles, AmountOfSubstanceUnit.Micromole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.MicropoundMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromMicropoundMoles(QuantityValue micropoundmoles) => new AmountOfSubstance(micropoundmoles, AmountOfSubstanceUnit.MicropoundMole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.Millimole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromMillimoles(QuantityValue millimoles) => new AmountOfSubstance(millimoles, AmountOfSubstanceUnit.Millimole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.MillipoundMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromMillipoundMoles(QuantityValue millipoundmoles) => new AmountOfSubstance(millipoundmoles, AmountOfSubstanceUnit.MillipoundMole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.Mole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromMoles(QuantityValue moles) => new AmountOfSubstance(moles, AmountOfSubstanceUnit.Mole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.Nanomole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromNanomoles(QuantityValue nanomoles) => new AmountOfSubstance(nanomoles, AmountOfSubstanceUnit.Nanomole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.NanopoundMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromNanopoundMoles(QuantityValue nanopoundmoles) => new AmountOfSubstance(nanopoundmoles, AmountOfSubstanceUnit.NanopoundMole);

        /// <summary>
        ///     Creates a <see cref="AmountOfSubstance"/> from <see cref="AmountOfSubstanceUnit.PoundMole"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static AmountOfSubstance FromPoundMoles(QuantityValue poundmoles) => new AmountOfSubstance(poundmoles, AmountOfSubstanceUnit.PoundMole);
        ...
        public QuantityValue As(AmountOfSubstanceUnit unit) => GetValueAs(unit);
