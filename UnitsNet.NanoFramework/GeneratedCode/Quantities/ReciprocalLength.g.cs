...
namespace UnitsNet
{
    ...
    public struct  ReciprocalLength
    {
        ...
        /// </summary>
        public static ReciprocalLength MaxValue { get; } = new ReciprocalLength(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static ReciprocalLength MinValue { get; } = new ReciprocalLength(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseCentimeters(QuantityValue inversecentimeters) => new ReciprocalLength(inversecentimeters, ReciprocalLengthUnit.InverseCentimeter);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseFoot"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseFeet(QuantityValue inversefeet) => new ReciprocalLength(inversefeet, ReciprocalLengthUnit.InverseFoot);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseInch"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseInches(QuantityValue inverseinches) => new ReciprocalLength(inverseinches, ReciprocalLengthUnit.InverseInch);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseMeter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseMeters(QuantityValue inversemeters) => new ReciprocalLength(inversemeters, ReciprocalLengthUnit.InverseMeter);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseMicroinch"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseMicroinches(QuantityValue inversemicroinches) => new ReciprocalLength(inversemicroinches, ReciprocalLengthUnit.InverseMicroinch);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseMil"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseMils(QuantityValue inversemils) => new ReciprocalLength(inversemils, ReciprocalLengthUnit.InverseMil);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseMile"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseMiles(QuantityValue inversemiles) => new ReciprocalLength(inversemiles, ReciprocalLengthUnit.InverseMile);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseMillimeter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseMillimeters(QuantityValue inversemillimeters) => new ReciprocalLength(inversemillimeters, ReciprocalLengthUnit.InverseMillimeter);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseUsSurveyFoot"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseUsSurveyFeet(QuantityValue inverseussurveyfeet) => new ReciprocalLength(inverseussurveyfeet, ReciprocalLengthUnit.InverseUsSurveyFoot);

        /// <summary>
        ///     Creates a <see cref="ReciprocalLength"/> from <see cref="ReciprocalLengthUnit.InverseYard"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ReciprocalLength FromInverseYards(QuantityValue inverseyards) => new ReciprocalLength(inverseyards, ReciprocalLengthUnit.InverseYard);
        ...
        public QuantityValue As(ReciprocalLengthUnit unit) => GetValueAs(unit);
