...
namespace UnitsNet
{
    ...
    public struct  ElectricCharge
    {
        ...
        /// </summary>
        public static ElectricCharge MaxValue { get; } = new ElectricCharge(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static ElectricCharge MinValue { get; } = new ElectricCharge(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricCharge FromAmpereHours(QuantityValue amperehours) => new ElectricCharge(amperehours, ElectricChargeUnit.AmpereHour);

        /// <summary>
        ///     Creates a <see cref="ElectricCharge"/> from <see cref="ElectricChargeUnit.Coulomb"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricCharge FromCoulombs(QuantityValue coulombs) => new ElectricCharge(coulombs, ElectricChargeUnit.Coulomb);

        /// <summary>
        ///     Creates a <see cref="ElectricCharge"/> from <see cref="ElectricChargeUnit.KiloampereHour"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricCharge FromKiloampereHours(QuantityValue kiloamperehours) => new ElectricCharge(kiloamperehours, ElectricChargeUnit.KiloampereHour);

        /// <summary>
        ///     Creates a <see cref="ElectricCharge"/> from <see cref="ElectricChargeUnit.MegaampereHour"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricCharge FromMegaampereHours(QuantityValue megaamperehours) => new ElectricCharge(megaamperehours, ElectricChargeUnit.MegaampereHour);

        /// <summary>
        ///     Creates a <see cref="ElectricCharge"/> from <see cref="ElectricChargeUnit.MilliampereHour"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricCharge FromMilliampereHours(QuantityValue milliamperehours) => new ElectricCharge(milliamperehours, ElectricChargeUnit.MilliampereHour);
        ...
        public QuantityValue As(ElectricChargeUnit unit) => GetValueAs(unit);
