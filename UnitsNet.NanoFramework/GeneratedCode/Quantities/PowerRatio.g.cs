...
namespace UnitsNet
{
    ...
    public struct  PowerRatio
    {
        ...
        /// </summary>
        public static PowerRatio MaxValue { get; } = new PowerRatio(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static PowerRatio MinValue { get; } = new PowerRatio(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static PowerRatio FromDecibelMilliwatts(QuantityValue decibelmilliwatts) => new PowerRatio(decibelmilliwatts, PowerRatioUnit.DecibelMilliwatt);

        /// <summary>
        ///     Creates a <see cref="PowerRatio"/> from <see cref="PowerRatioUnit.DecibelWatt"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static PowerRatio FromDecibelWatts(QuantityValue decibelwatts) => new PowerRatio(decibelwatts, PowerRatioUnit.DecibelWatt);
        ...
        public QuantityValue As(PowerRatioUnit unit) => GetValueAs(unit);
