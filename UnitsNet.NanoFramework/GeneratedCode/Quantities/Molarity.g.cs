...
namespace UnitsNet
{
    ...
    public struct  Molarity
    {
        ...
        /// </summary>
        public static Molarity MaxValue { get; } = new Molarity(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static Molarity MinValue { get; } = new Molarity(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromCentimolesPerLiter(QuantityValue centimolesperliter) => new Molarity(centimolesperliter, MolarityUnit.CentimolePerLiter);

        /// <summary>
        ///     Creates a <see cref="Molarity"/> from <see cref="MolarityUnit.DecimolePerLiter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromDecimolesPerLiter(QuantityValue decimolesperliter) => new Molarity(decimolesperliter, MolarityUnit.DecimolePerLiter);

        /// <summary>
        ///     Creates a <see cref="Molarity"/> from <see cref="MolarityUnit.MicromolePerLiter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromMicromolesPerLiter(QuantityValue micromolesperliter) => new Molarity(micromolesperliter, MolarityUnit.MicromolePerLiter);

        /// <summary>
        ///     Creates a <see cref="Molarity"/> from <see cref="MolarityUnit.MillimolePerLiter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromMillimolesPerLiter(QuantityValue millimolesperliter) => new Molarity(millimolesperliter, MolarityUnit.MillimolePerLiter);

        /// <summary>
        ///     Creates a <see cref="Molarity"/> from <see cref="MolarityUnit.MolePerCubicMeter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromMolesPerCubicMeter(QuantityValue molespercubicmeter) => new Molarity(molespercubicmeter, MolarityUnit.MolePerCubicMeter);

        /// <summary>
        ///     Creates a <see cref="Molarity"/> from <see cref="MolarityUnit.MolePerLiter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromMolesPerLiter(QuantityValue molesperliter) => new Molarity(molesperliter, MolarityUnit.MolePerLiter);

        /// <summary>
        ///     Creates a <see cref="Molarity"/> from <see cref="MolarityUnit.NanomolePerLiter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromNanomolesPerLiter(QuantityValue nanomolesperliter) => new Molarity(nanomolesperliter, MolarityUnit.NanomolePerLiter);

        /// <summary>
        ///     Creates a <see cref="Molarity"/> from <see cref="MolarityUnit.PicomolePerLiter"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Molarity FromPicomolesPerLiter(QuantityValue picomolesperliter) => new Molarity(picomolesperliter, MolarityUnit.PicomolePerLiter);
        ...
        public QuantityValue As(MolarityUnit unit) => GetValueAs(unit);
