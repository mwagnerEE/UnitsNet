...
namespace UnitsNet
{
    ...
    public struct  Capacitance
    {
        ...
        /// </summary>
        public static Capacitance MaxValue { get; } = new Capacitance(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static Capacitance MinValue { get; } = new Capacitance(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Capacitance FromFarads(QuantityValue farads) => new Capacitance(farads, CapacitanceUnit.Farad);

        /// <summary>
        ///     Creates a <see cref="Capacitance"/> from <see cref="CapacitanceUnit.Kilofarad"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Capacitance FromKilofarads(QuantityValue kilofarads) => new Capacitance(kilofarads, CapacitanceUnit.Kilofarad);

        /// <summary>
        ///     Creates a <see cref="Capacitance"/> from <see cref="CapacitanceUnit.Megafarad"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Capacitance FromMegafarads(QuantityValue megafarads) => new Capacitance(megafarads, CapacitanceUnit.Megafarad);

        /// <summary>
        ///     Creates a <see cref="Capacitance"/> from <see cref="CapacitanceUnit.Microfarad"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Capacitance FromMicrofarads(QuantityValue microfarads) => new Capacitance(microfarads, CapacitanceUnit.Microfarad);

        /// <summary>
        ///     Creates a <see cref="Capacitance"/> from <see cref="CapacitanceUnit.Millifarad"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Capacitance FromMillifarads(QuantityValue millifarads) => new Capacitance(millifarads, CapacitanceUnit.Millifarad);

        /// <summary>
        ///     Creates a <see cref="Capacitance"/> from <see cref="CapacitanceUnit.Nanofarad"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Capacitance FromNanofarads(QuantityValue nanofarads) => new Capacitance(nanofarads, CapacitanceUnit.Nanofarad);

        /// <summary>
        ///     Creates a <see cref="Capacitance"/> from <see cref="CapacitanceUnit.Picofarad"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Capacitance FromPicofarads(QuantityValue picofarads) => new Capacitance(picofarads, CapacitanceUnit.Picofarad);
        ...
        public QuantityValue As(CapacitanceUnit unit) => GetValueAs(unit);
