...
namespace UnitsNet
{
    ...
    public struct  LapseRate
    {
        ...
        /// </summary>
        public static LapseRate MaxValue { get; } = new LapseRate(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static LapseRate MinValue { get; } = new LapseRate(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static LapseRate FromDegreesCelciusPerKilometer(QuantityValue degreescelciusperkilometer) => new LapseRate(degreescelciusperkilometer, LapseRateUnit.DegreeCelsiusPerKilometer);
        ...
        public QuantityValue As(LapseRateUnit unit) => GetValueAs(unit);
