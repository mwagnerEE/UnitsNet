...
namespace UnitsNet
{
    ...
    public struct  Ratio
    {
        ...
        /// </summary>
        public static Ratio MaxValue { get; } = new Ratio(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static Ratio MinValue { get; } = new Ratio(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Ratio FromDecimalFractions(QuantityValue decimalfractions) => new Ratio(decimalfractions, RatioUnit.DecimalFraction);

        /// <summary>
        ///     Creates a <see cref="Ratio"/> from <see cref="RatioUnit.PartPerBillion"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Ratio FromPartsPerBillion(QuantityValue partsperbillion) => new Ratio(partsperbillion, RatioUnit.PartPerBillion);

        /// <summary>
        ///     Creates a <see cref="Ratio"/> from <see cref="RatioUnit.PartPerMillion"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Ratio FromPartsPerMillion(QuantityValue partspermillion) => new Ratio(partspermillion, RatioUnit.PartPerMillion);

        /// <summary>
        ///     Creates a <see cref="Ratio"/> from <see cref="RatioUnit.PartPerThousand"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Ratio FromPartsPerThousand(QuantityValue partsperthousand) => new Ratio(partsperthousand, RatioUnit.PartPerThousand);

        /// <summary>
        ///     Creates a <see cref="Ratio"/> from <see cref="RatioUnit.PartPerTrillion"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Ratio FromPartsPerTrillion(QuantityValue partspertrillion) => new Ratio(partspertrillion, RatioUnit.PartPerTrillion);

        /// <summary>
        ///     Creates a <see cref="Ratio"/> from <see cref="RatioUnit.Percent"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Ratio FromPercent(QuantityValue percent) => new Ratio(percent, RatioUnit.Percent);
        ...
        public QuantityValue As(RatioUnit unit) => GetValueAs(unit);
