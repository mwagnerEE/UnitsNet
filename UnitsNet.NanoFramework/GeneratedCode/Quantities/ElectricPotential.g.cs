...
namespace UnitsNet
{
    ...
    public struct  ElectricPotential
    {
        ...
        /// </summary>
        public static ElectricPotential MaxValue { get; } = new ElectricPotential(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static ElectricPotential MinValue { get; } = new ElectricPotential(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricPotential FromKilovolts(QuantityValue kilovolts) => new ElectricPotential(kilovolts, ElectricPotentialUnit.Kilovolt);

        /// <summary>
        ///     Creates a <see cref="ElectricPotential"/> from <see cref="ElectricPotentialUnit.Megavolt"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricPotential FromMegavolts(QuantityValue megavolts) => new ElectricPotential(megavolts, ElectricPotentialUnit.Megavolt);

        /// <summary>
        ///     Creates a <see cref="ElectricPotential"/> from <see cref="ElectricPotentialUnit.Microvolt"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricPotential FromMicrovolts(QuantityValue microvolts) => new ElectricPotential(microvolts, ElectricPotentialUnit.Microvolt);

        /// <summary>
        ///     Creates a <see cref="ElectricPotential"/> from <see cref="ElectricPotentialUnit.Millivolt"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricPotential FromMillivolts(QuantityValue millivolts) => new ElectricPotential(millivolts, ElectricPotentialUnit.Millivolt);

        /// <summary>
        ///     Creates a <see cref="ElectricPotential"/> from <see cref="ElectricPotentialUnit.Volt"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricPotential FromVolts(QuantityValue volts) => new ElectricPotential(volts, ElectricPotentialUnit.Volt);
        ...
        public QuantityValue As(ElectricPotentialUnit unit) => GetValueAs(unit);
