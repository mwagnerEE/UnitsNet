...
namespace UnitsNet
{
    ...
    public struct  SolidAngle
    {
        ...
        /// </summary>
        public static SolidAngle MaxValue { get; } = new SolidAngle(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static SolidAngle MinValue { get; } = new SolidAngle(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static SolidAngle FromSteradians(QuantityValue steradians) => new SolidAngle(steradians, SolidAngleUnit.Steradian);
        ...
        public QuantityValue As(SolidAngleUnit unit) => GetValueAs(unit);
