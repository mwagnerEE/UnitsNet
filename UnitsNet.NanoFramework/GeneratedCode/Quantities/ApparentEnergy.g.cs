...
namespace UnitsNet
{
    ...
    public struct  ApparentEnergy
    {
        ...
        /// </summary>
        public static ApparentEnergy MaxValue { get; } = new ApparentEnergy(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static ApparentEnergy MinValue { get; } = new ApparentEnergy(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ApparentEnergy FromKilovoltampereHours(QuantityValue kilovoltamperehours) => new ApparentEnergy(kilovoltamperehours, ApparentEnergyUnit.KilovoltampereHour);

        /// <summary>
        ///     Creates a <see cref="ApparentEnergy"/> from <see cref="ApparentEnergyUnit.MegavoltampereHour"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ApparentEnergy FromMegavoltampereHours(QuantityValue megavoltamperehours) => new ApparentEnergy(megavoltamperehours, ApparentEnergyUnit.MegavoltampereHour);

        /// <summary>
        ///     Creates a <see cref="ApparentEnergy"/> from <see cref="ApparentEnergyUnit.VoltampereHour"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ApparentEnergy FromVoltampereHours(QuantityValue voltamperehours) => new ApparentEnergy(voltamperehours, ApparentEnergyUnit.VoltampereHour);
        ...
        public QuantityValue As(ApparentEnergyUnit unit) => GetValueAs(unit);
