...
namespace UnitsNet
{
    ...
    public struct  Level
    {
        ...
        /// </summary>
        public static Level MaxValue { get; } = new Level(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static Level MinValue { get; } = new Level(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Level FromDecibels(QuantityValue decibels) => new Level(decibels, LevelUnit.Decibel);

        /// <summary>
        ///     Creates a <see cref="Level"/> from <see cref="LevelUnit.Neper"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Level FromNepers(QuantityValue nepers) => new Level(nepers, LevelUnit.Neper);
        ...
        public QuantityValue As(LevelUnit unit) => GetValueAs(unit);
