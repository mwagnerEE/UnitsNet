...
namespace UnitsNet
{
    ...
    public struct  Temperature
    {
        ...
        /// </summary>
        public static Temperature MaxValue { get; } = new Temperature(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static Temperature MinValue { get; } = new Temperature(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromDegreesCelsius(QuantityValue degreescelsius) => new Temperature(degreescelsius, TemperatureUnit.DegreeCelsius);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.DegreeDelisle"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromDegreesDelisle(QuantityValue degreesdelisle) => new Temperature(degreesdelisle, TemperatureUnit.DegreeDelisle);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.DegreeFahrenheit"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromDegreesFahrenheit(QuantityValue degreesfahrenheit) => new Temperature(degreesfahrenheit, TemperatureUnit.DegreeFahrenheit);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.DegreeNewton"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromDegreesNewton(QuantityValue degreesnewton) => new Temperature(degreesnewton, TemperatureUnit.DegreeNewton);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.DegreeRankine"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromDegreesRankine(QuantityValue degreesrankine) => new Temperature(degreesrankine, TemperatureUnit.DegreeRankine);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.DegreeReaumur"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromDegreesReaumur(QuantityValue degreesreaumur) => new Temperature(degreesreaumur, TemperatureUnit.DegreeReaumur);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.DegreeRoemer"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromDegreesRoemer(QuantityValue degreesroemer) => new Temperature(degreesroemer, TemperatureUnit.DegreeRoemer);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.Kelvin"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromKelvins(QuantityValue kelvins) => new Temperature(kelvins, TemperatureUnit.Kelvin);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.MillidegreeCelsius"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromMillidegreesCelsius(QuantityValue millidegreescelsius) => new Temperature(millidegreescelsius, TemperatureUnit.MillidegreeCelsius);

        /// <summary>
        ///     Creates a <see cref="Temperature"/> from <see cref="TemperatureUnit.SolarTemperature"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Temperature FromSolarTemperatures(QuantityValue solartemperatures) => new Temperature(solartemperatures, TemperatureUnit.SolarTemperature);
        ...
        public QuantityValue As(TemperatureUnit unit) => GetValueAs(unit);
        ...
        private QuantityValue GetValueAs(TemperatureUnit unit)
        {
            if (Unit == unit)
                return _value;
