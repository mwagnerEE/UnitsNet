...
namespace UnitsNet
{
    ...
    public struct  RatioChangeRate
    {
        ...
        /// </summary>
        public static RatioChangeRate MaxValue { get; } = new RatioChangeRate(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static RatioChangeRate MinValue { get; } = new RatioChangeRate(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static RatioChangeRate FromDecimalFractionsPerSecond(QuantityValue decimalfractionspersecond) => new RatioChangeRate(decimalfractionspersecond, RatioChangeRateUnit.DecimalFractionPerSecond);

        /// <summary>
        ///     Creates a <see cref="RatioChangeRate"/> from <see cref="RatioChangeRateUnit.PercentPerSecond"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static RatioChangeRate FromPercentsPerSecond(QuantityValue percentspersecond) => new RatioChangeRate(percentspersecond, RatioChangeRateUnit.PercentPerSecond);
        ...
        public QuantityValue As(RatioChangeRateUnit unit) => GetValueAs(unit);
