...
namespace UnitsNet
{
    ...
    public struct  FuelEfficiency
    {
        ...
        /// </summary>
        public static FuelEfficiency MaxValue { get; } = new FuelEfficiency(QuantityValue.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Duration
        /// </summary>
        public static FuelEfficiency MinValue { get; } = new FuelEfficiency(QuantityValue.MinValue, BaseUnit);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static FuelEfficiency FromKilometersPerLiters(QuantityValue kilometersperliters) => new FuelEfficiency(kilometersperliters, FuelEfficiencyUnit.KilometerPerLiter);

        /// <summary>
        ///     Creates a <see cref="FuelEfficiency"/> from <see cref="FuelEfficiencyUnit.LiterPer100Kilometers"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static FuelEfficiency FromLitersPer100Kilometers(QuantityValue litersper100kilometers) => new FuelEfficiency(litersper100kilometers, FuelEfficiencyUnit.LiterPer100Kilometers);

        /// <summary>
        ///     Creates a <see cref="FuelEfficiency"/> from <see cref="FuelEfficiencyUnit.MilePerUkGallon"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static FuelEfficiency FromMilesPerUkGallon(QuantityValue milesperukgallon) => new FuelEfficiency(milesperukgallon, FuelEfficiencyUnit.MilePerUkGallon);

        /// <summary>
        ///     Creates a <see cref="FuelEfficiency"/> from <see cref="FuelEfficiencyUnit.MilePerUsGallon"/>.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static FuelEfficiency FromMilesPerUsGallon(QuantityValue milesperusgallon) => new FuelEfficiency(milesperusgallon, FuelEfficiencyUnit.MilePerUsGallon);
        ...
        public QuantityValue As(FuelEfficiencyUnit unit) => GetValueAs(unit);
