...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class Frequency :  QuantityBase, IQuantity<FrequencyUnit>, IEquatable<Frequency>, IComparable, IComparable<Frequency>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new Frequency((QuantityValue)value, (FrequencyUnit)unit);
#endif
        ...
        public Frequency(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Frequency(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Frequency(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Frequency(QuantityValue value, FrequencyUnit unit) : base(value, BaseDimensions)
        {
        ...
        public Frequency(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<FrequencyUnit> QuantityInfo => Info;
        ...
        /// </summary>
        public QuantityValue BUnits => As(FrequencyUnit.BUnit);
        ...
        internal static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<Frequency>(FrequencyUnit.BUnit, FrequencyUnit.Hertz, quantity => new Frequency(QuantityValue.Sqrt(quantity.Value * 1e3), FrequencyUnit.Hertz));
        ...
        /// <summary>Negate the <see cref="Frequency"/>.</summary>
        public new Frequency Negate()
        {
            return new Frequency(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="Frequency"/> together</summary>
        public Frequency Add(Frequency other)
        {
            return new Frequency(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="Frequency"/> from another</summary>
        public Frequency Subtract(Frequency other)
        {
            return new Frequency(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="Frequency"/> by a constant</summary>
        public new Frequency Scale(double scaleFactor)
        {
            return new Frequency(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="Frequency"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((Frequency)other);

        /// <summary>Subtract one <see cref="Frequency"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((Frequency)other);
        ...
        {
            if(other is Frequency otherFrequency)
            {
                return Value.CompareTo(otherFrequency.GetValueAs(this.Unit));
            }
        ...
        public override Frequency ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<FrequencyUnit> IQuantity<FrequencyUnit>.ToUnit(FrequencyUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<FrequencyUnit> IQuantity<FrequencyUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<FrequencyUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(FrequencyUnit unit)
        {
