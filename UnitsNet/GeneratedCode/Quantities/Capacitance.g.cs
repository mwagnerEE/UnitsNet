...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class Capacitance :  QuantityBase, IQuantity<CapacitanceUnit>, IEquatable<Capacitance>, IComparable, IComparable<Capacitance>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new Capacitance((QuantityValue)value, (CapacitanceUnit)unit);
#endif
        ...
        public Capacitance(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Capacitance(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Capacitance(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Capacitance(QuantityValue value, CapacitanceUnit unit) : base(value, BaseDimensions)
        {
        ...
        public Capacitance(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<CapacitanceUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) farads;
        ...
        {
            QuantityValue value = (QuantityValue) kilofarads;
        ...
        {
            QuantityValue value = (QuantityValue) megafarads;
        ...
        {
            QuantityValue value = (QuantityValue) microfarads;
        ...
        {
            QuantityValue value = (QuantityValue) millifarads;
        ...
        {
            QuantityValue value = (QuantityValue) nanofarads;
        ...
        {
            QuantityValue value = (QuantityValue) picofarads;
        ...
        {
            return new Capacitance((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="Capacitance"/>.</summary>
        public new Capacitance Negate()
        {
            return new Capacitance(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="Capacitance"/> together</summary>
        public Capacitance Add(Capacitance other)
        {
            return new Capacitance(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="Capacitance"/> from another</summary>
        public Capacitance Subtract(Capacitance other)
        {
            return new Capacitance(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="Capacitance"/> by a constant</summary>
        public new Capacitance Scale(double scaleFactor)
        {
            return new Capacitance(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="Capacitance"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((Capacitance)other);

        /// <summary>Subtract one <see cref="Capacitance"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((Capacitance)other);
        ...
        {
            if(other is Capacitance otherCapacitance)
            {
                return Value.CompareTo(otherCapacitance.GetValueAs(this.Unit));
            }
        ...
        public override Capacitance ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<CapacitanceUnit> IQuantity<CapacitanceUnit>.ToUnit(CapacitanceUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<CapacitanceUnit> IQuantity<CapacitanceUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<CapacitanceUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(CapacitanceUnit unit)
        {
