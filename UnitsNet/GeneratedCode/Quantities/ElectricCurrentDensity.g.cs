...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class ElectricCurrentDensity :  QuantityBase, IQuantity<ElectricCurrentDensityUnit>, IEquatable<ElectricCurrentDensity>, IComparable, IComparable<ElectricCurrentDensity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ElectricCurrentDensity((QuantityValue)value, (ElectricCurrentDensityUnit)unit);
#endif
        ...
        public ElectricCurrentDensity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricCurrentDensity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricCurrentDensity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricCurrentDensity(QuantityValue value, ElectricCurrentDensityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ElectricCurrentDensity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ElectricCurrentDensityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) amperespersquarefoot;
        ...
        {
            QuantityValue value = (QuantityValue) amperespersquareinch;
        ...
        {
            QuantityValue value = (QuantityValue) amperespersquaremeter;
        ...
        {
            return new ElectricCurrentDensity((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ElectricCurrentDensity"/>.</summary>
        public new ElectricCurrentDensity Negate()
        {
            return new ElectricCurrentDensity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ElectricCurrentDensity"/> together</summary>
        public ElectricCurrentDensity Add(ElectricCurrentDensity other)
        {
            return new ElectricCurrentDensity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ElectricCurrentDensity"/> from another</summary>
        public ElectricCurrentDensity Subtract(ElectricCurrentDensity other)
        {
            return new ElectricCurrentDensity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ElectricCurrentDensity"/> by a constant</summary>
        public new ElectricCurrentDensity Scale(double scaleFactor)
        {
            return new ElectricCurrentDensity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ElectricCurrentDensity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ElectricCurrentDensity)other);

        /// <summary>Subtract one <see cref="ElectricCurrentDensity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ElectricCurrentDensity)other);
        ...
        {
            if(other is ElectricCurrentDensity otherElectricCurrentDensity)
            {
                return Value.CompareTo(otherElectricCurrentDensity.GetValueAs(this.Unit));
            }
        ...
        public override ElectricCurrentDensity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ElectricCurrentDensityUnit> IQuantity<ElectricCurrentDensityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ElectricCurrentDensityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ElectricCurrentDensityUnit unit)
        {
