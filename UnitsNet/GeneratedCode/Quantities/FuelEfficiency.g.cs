...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class FuelEfficiency :  QuantityBase, IQuantity<FuelEfficiencyUnit>, IEquatable<FuelEfficiency>, IComparable, IComparable<FuelEfficiency>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new FuelEfficiency((QuantityValue)value, (FuelEfficiencyUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public FuelEfficiency() : this(0, BaseUnit)
        {
        }
        ...
        public FuelEfficiency(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public FuelEfficiency(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public FuelEfficiency(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new FuelEfficiency(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public FuelEfficiency(QuantityValue value, FuelEfficiencyUnit unit) : base(value, BaseDimensions)
        {
        ...
        public FuelEfficiency(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<FuelEfficiencyUnit> QuantityInfo => Info;
        ...
        /// <summary>Negate the <see cref="FuelEfficiency"/>.</summary>
        public new FuelEfficiency Negate()
        {
            return new FuelEfficiency(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="FuelEfficiency"/> together</summary>
        public FuelEfficiency Add(FuelEfficiency other)
        {
            return new FuelEfficiency(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="FuelEfficiency"/> from another</summary>
        public FuelEfficiency Subtract(FuelEfficiency other)
        {
            return new FuelEfficiency(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="FuelEfficiency"/> by a constant</summary>
        public new FuelEfficiency Scale(double scaleFactor)
        {
            return new FuelEfficiency(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="FuelEfficiency"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((FuelEfficiency)other);

        /// <summary>Subtract one <see cref="FuelEfficiency"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((FuelEfficiency)other);
        ...
        {
            if(other is FuelEfficiency otherFuelEfficiency)
            {
                return Value.CompareTo(otherFuelEfficiency.GetValueAs(this.Unit));
            }
        ...
        public override FuelEfficiency ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<FuelEfficiencyUnit> IQuantity<FuelEfficiencyUnit>.ToUnit(FuelEfficiencyUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<FuelEfficiencyUnit> IQuantity<FuelEfficiencyUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<FuelEfficiencyUnit>)ToUnit(unitSystem);
