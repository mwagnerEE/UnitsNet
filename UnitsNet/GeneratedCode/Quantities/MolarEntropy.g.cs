...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class MolarEntropy :  QuantityBase, IQuantity<MolarEntropyUnit>, IEquatable<MolarEntropy>, IComparable, IComparable<MolarEntropy>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new MolarEntropy((QuantityValue)value, (MolarEntropyUnit)unit);
#endif
        ...
        public MolarEntropy(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public MolarEntropy(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public MolarEntropy(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public MolarEntropy(QuantityValue value, MolarEntropyUnit unit) : base(value, BaseDimensions)
        {
        ...
        public MolarEntropy(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<MolarEntropyUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) joulespermolekelvin;
        ...
        {
            QuantityValue value = (QuantityValue) kilojoulespermolekelvin;
        ...
        {
            QuantityValue value = (QuantityValue) megajoulespermolekelvin;
        ...
        {
            return new MolarEntropy((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="MolarEntropy"/>.</summary>
        public new MolarEntropy Negate()
        {
            return new MolarEntropy(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="MolarEntropy"/> together</summary>
        public MolarEntropy Add(MolarEntropy other)
        {
            return new MolarEntropy(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="MolarEntropy"/> from another</summary>
        public MolarEntropy Subtract(MolarEntropy other)
        {
            return new MolarEntropy(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="MolarEntropy"/> by a constant</summary>
        public new MolarEntropy Scale(double scaleFactor)
        {
            return new MolarEntropy(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="MolarEntropy"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((MolarEntropy)other);

        /// <summary>Subtract one <see cref="MolarEntropy"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((MolarEntropy)other);
        ...
        {
            if(other is MolarEntropy otherMolarEntropy)
            {
                return Value.CompareTo(otherMolarEntropy.GetValueAs(this.Unit));
            }
        ...
        public override MolarEntropy ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<MolarEntropyUnit> IQuantity<MolarEntropyUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<MolarEntropyUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(MolarEntropyUnit unit)
        {
