...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApparentPower :  QuantityBase, IQuantity<ApparentPowerUnit>, IEquatable<ApparentPower>, IComparable, IComparable<ApparentPower>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ApparentPower((QuantityValue)value, (ApparentPowerUnit)unit);
#endif
        ...
        public ApparentPower(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ApparentPower(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ApparentPower(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ApparentPower(QuantityValue value, ApparentPowerUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ApparentPower(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ApparentPowerUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) gigavoltamperes;
        ...
        {
            QuantityValue value = (QuantityValue) kilovoltamperes;
        ...
        {
            QuantityValue value = (QuantityValue) megavoltamperes;
        ...
        {
            QuantityValue value = (QuantityValue) voltamperes;
        ...
        {
            return new ApparentPower((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ApparentPower"/>.</summary>
        public new ApparentPower Negate()
        {
            return new ApparentPower(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ApparentPower"/> together</summary>
        public ApparentPower Add(ApparentPower other)
        {
            return new ApparentPower(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ApparentPower"/> from another</summary>
        public ApparentPower Subtract(ApparentPower other)
        {
            return new ApparentPower(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ApparentPower"/> by a constant</summary>
        public new ApparentPower Scale(double scaleFactor)
        {
            return new ApparentPower(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ApparentPower"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ApparentPower)other);

        /// <summary>Subtract one <see cref="ApparentPower"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ApparentPower)other);
        ...
        {
            if(other is ApparentPower otherApparentPower)
            {
                return Value.CompareTo(otherApparentPower.GetValueAs(this.Unit));
            }
        ...
        public override ApparentPower ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ApparentPowerUnit> IQuantity<ApparentPowerUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ApparentPowerUnit>)ToUnit(unitSystem);
