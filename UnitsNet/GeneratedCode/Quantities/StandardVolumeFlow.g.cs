...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class StandardVolumeFlow :  QuantityBase, IQuantity<StandardVolumeFlowUnit>, IEquatable<StandardVolumeFlow>, IComparable, IComparable<StandardVolumeFlow>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new StandardVolumeFlow((QuantityValue)value, (StandardVolumeFlowUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public StandardVolumeFlow() : this(0, BaseUnit)
        {
        }
        ...
        public StandardVolumeFlow(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public StandardVolumeFlow(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public StandardVolumeFlow(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new StandardVolumeFlow(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public StandardVolumeFlow(QuantityValue value, StandardVolumeFlowUnit unit) : base(value, BaseDimensions)
        {
        ...
        public StandardVolumeFlow(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<StandardVolumeFlowUnit> QuantityInfo => Info;
        ...
        /// <summary>Negate the <see cref="StandardVolumeFlow"/>.</summary>
        public new StandardVolumeFlow Negate()
        {
            return new StandardVolumeFlow(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="StandardVolumeFlow"/> together</summary>
        public StandardVolumeFlow Add(StandardVolumeFlow other)
        {
            return new StandardVolumeFlow(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="StandardVolumeFlow"/> from another</summary>
        public StandardVolumeFlow Subtract(StandardVolumeFlow other)
        {
            return new StandardVolumeFlow(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="StandardVolumeFlow"/> by a constant</summary>
        public new StandardVolumeFlow Scale(double scaleFactor)
        {
            return new StandardVolumeFlow(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="StandardVolumeFlow"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((StandardVolumeFlow)other);

        /// <summary>Subtract one <see cref="StandardVolumeFlow"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((StandardVolumeFlow)other);
        ...
        {
            if(other is StandardVolumeFlow otherStandardVolumeFlow)
            {
                return Value.CompareTo(otherStandardVolumeFlow.GetValueAs(this.Unit));
            }
        ...
        public override StandardVolumeFlow ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<StandardVolumeFlowUnit> IQuantity<StandardVolumeFlowUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<StandardVolumeFlowUnit>)ToUnit(unitSystem);
