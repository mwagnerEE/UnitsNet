...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class ElectricInductance :  QuantityBase, IQuantity<ElectricInductanceUnit>, IEquatable<ElectricInductance>, IComparable, IComparable<ElectricInductance>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ElectricInductance((QuantityValue)value, (ElectricInductanceUnit)unit);
#endif
        ...
        public ElectricInductance(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricInductance(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricInductance(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricInductance(QuantityValue value, ElectricInductanceUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ElectricInductance(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ElectricInductanceUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) henries;
        ...
        {
            QuantityValue value = (QuantityValue) microhenries;
        ...
        {
            QuantityValue value = (QuantityValue) millihenries;
        ...
        {
            QuantityValue value = (QuantityValue) nanohenries;
        ...
        {
            return new ElectricInductance((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ElectricInductance"/>.</summary>
        public new ElectricInductance Negate()
        {
            return new ElectricInductance(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ElectricInductance"/> together</summary>
        public ElectricInductance Add(ElectricInductance other)
        {
            return new ElectricInductance(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ElectricInductance"/> from another</summary>
        public ElectricInductance Subtract(ElectricInductance other)
        {
            return new ElectricInductance(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ElectricInductance"/> by a constant</summary>
        public new ElectricInductance Scale(double scaleFactor)
        {
            return new ElectricInductance(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ElectricInductance"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ElectricInductance)other);

        /// <summary>Subtract one <see cref="ElectricInductance"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ElectricInductance)other);
        ...
        {
            if(other is ElectricInductance otherElectricInductance)
            {
                return Value.CompareTo(otherElectricInductance.GetValueAs(this.Unit));
            }
        ...
        public override ElectricInductance ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ElectricInductanceUnit> IQuantity<ElectricInductanceUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ElectricInductanceUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ElectricInductanceUnit unit)
        {
