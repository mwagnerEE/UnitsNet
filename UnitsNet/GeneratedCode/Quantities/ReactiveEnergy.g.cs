...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReactiveEnergy :  QuantityBase, IQuantity<ReactiveEnergyUnit>, IEquatable<ReactiveEnergy>, IComparable, IComparable<ReactiveEnergy>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ReactiveEnergy((QuantityValue)value, (ReactiveEnergyUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public ReactiveEnergy() : this(0, BaseUnit)
        {
        }
        ...
        public ReactiveEnergy(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReactiveEnergy(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReactiveEnergy(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReactiveEnergy(QuantityValue value, ReactiveEnergyUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ReactiveEnergy(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ReactiveEnergyUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) kilovoltamperereactivehours;
        ...
        {
            QuantityValue value = (QuantityValue) megavoltamperereactivehours;
        ...
        {
            QuantityValue value = (QuantityValue) voltamperereactivehours;
        ...
        {
            return new ReactiveEnergy((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ReactiveEnergy"/>.</summary>
        public new ReactiveEnergy Negate()
        {
            return new ReactiveEnergy(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ReactiveEnergy"/> together</summary>
        public ReactiveEnergy Add(ReactiveEnergy other)
        {
            return new ReactiveEnergy(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ReactiveEnergy"/> from another</summary>
        public ReactiveEnergy Subtract(ReactiveEnergy other)
        {
            return new ReactiveEnergy(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ReactiveEnergy"/> by a constant</summary>
        public new ReactiveEnergy Scale(double scaleFactor)
        {
            return new ReactiveEnergy(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ReactiveEnergy"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ReactiveEnergy)other);

        /// <summary>Subtract one <see cref="ReactiveEnergy"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ReactiveEnergy)other);
        ...
        {
            if(other is ReactiveEnergy otherReactiveEnergy)
            {
                return Value.CompareTo(otherReactiveEnergy.GetValueAs(this.Unit));
            }
        ...
        public override ReactiveEnergy ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ReactiveEnergyUnit> IQuantity<ReactiveEnergyUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ReactiveEnergyUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ReactiveEnergyUnit unit)
        {
