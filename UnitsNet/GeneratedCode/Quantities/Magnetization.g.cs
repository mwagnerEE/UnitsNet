...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class Magnetization :  QuantityBase, IQuantity<MagnetizationUnit>, IEquatable<Magnetization>, IComparable, IComparable<Magnetization>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new Magnetization((QuantityValue)value, (MagnetizationUnit)unit);
#endif
        ...
        public Magnetization(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Magnetization(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Magnetization(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Magnetization(QuantityValue value, MagnetizationUnit unit) : base(value, BaseDimensions)
        {
        ...
        public Magnetization(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<MagnetizationUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) amperespermeter;
        ...
        {
            return new Magnetization((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="Magnetization"/>.</summary>
        public new Magnetization Negate()
        {
            return new Magnetization(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="Magnetization"/> together</summary>
        public Magnetization Add(Magnetization other)
        {
            return new Magnetization(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="Magnetization"/> from another</summary>
        public Magnetization Subtract(Magnetization other)
        {
            return new Magnetization(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="Magnetization"/> by a constant</summary>
        public new Magnetization Scale(double scaleFactor)
        {
            return new Magnetization(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="Magnetization"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((Magnetization)other);

        /// <summary>Subtract one <see cref="Magnetization"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((Magnetization)other);
        ...
        {
            if(other is Magnetization otherMagnetization)
            {
                return Value.CompareTo(otherMagnetization.GetValueAs(this.Unit));
            }
        ...
        IQuantity IQuantity.ToUnit(Enum unit, UnitConverter unitConverter)
        {
            ...
            return ToUnit(unitAsMagnetizationUnit, unitConverter);
        }

        /// <inheritdoc cref="IQuantity.ToUnit(UnitSystem)"/>
#if NET5_0_OR_GREATER
        public override Magnetization ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<MagnetizationUnit> IQuantity<MagnetizationUnit>.ToUnit(MagnetizationUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<MagnetizationUnit> IQuantity<MagnetizationUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<MagnetizationUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(MagnetizationUnit unit)
        {
