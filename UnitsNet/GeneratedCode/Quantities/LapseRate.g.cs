...
namespace UnitsNet
{
    ...
    [DataContract]
    public partial class LapseRate :  QuantityBase, IQuantity<LapseRateUnit>, IEquatable<LapseRate>, IComparable, IComparable<LapseRate>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new LapseRate((QuantityValue)value, (LapseRateUnit)unit);
#endif
        ...
        public LapseRate(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LapseRate(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LapseRate(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LapseRate(QuantityValue value, LapseRateUnit unit) : base(value, BaseDimensions)
        {
        ...
        public LapseRate(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<LapseRateUnit> QuantityInfo => Info;
        ...
        /// <summary>Negate the <see cref="LapseRate"/>.</summary>
        public new LapseRate Negate()
        {
            return new LapseRate(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="LapseRate"/> together</summary>
        public LapseRate Add(LapseRate other)
        {
            return new LapseRate(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="LapseRate"/> from another</summary>
        public LapseRate Subtract(LapseRate other)
        {
            return new LapseRate(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="LapseRate"/> by a constant</summary>
        public new LapseRate Scale(double scaleFactor)
        {
            return new LapseRate(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="LapseRate"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((LapseRate)other);

        /// <summary>Subtract one <see cref="LapseRate"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((LapseRate)other);
        ...
        {
            if(other is LapseRate otherLapseRate)
            {
                return Value.CompareTo(otherLapseRate.GetValueAs(this.Unit));
            }
        ...
        public override LapseRate ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<LapseRateUnit> IQuantity<LapseRateUnit>.ToUnit(LapseRateUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<LapseRateUnit> IQuantity<LapseRateUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<LapseRateUnit>)ToUnit(unitSystem);
