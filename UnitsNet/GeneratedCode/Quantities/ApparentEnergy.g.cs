...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApparentEnergy :  QuantityBase, IQuantity<ApparentEnergyUnit>, IEquatable<ApparentEnergy>, IComparable, IComparable<ApparentEnergy>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ApparentEnergy((QuantityValue)value, (ApparentEnergyUnit)unit);
#endif
        ...
        public ApparentEnergy(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ApparentEnergy(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ApparentEnergy(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ApparentEnergy(QuantityValue value, ApparentEnergyUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ApparentEnergy(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ApparentEnergyUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) kilovoltamperehours;
        ...
        {
            QuantityValue value = (QuantityValue) megavoltamperehours;
        ...
        {
            QuantityValue value = (QuantityValue) voltamperehours;
        ...
        {
            return new ApparentEnergy((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ApparentEnergy"/>.</summary>
        public new ApparentEnergy Negate()
        {
            return new ApparentEnergy(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ApparentEnergy"/> together</summary>
        public ApparentEnergy Add(ApparentEnergy other)
        {
            return new ApparentEnergy(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ApparentEnergy"/> from another</summary>
        public ApparentEnergy Subtract(ApparentEnergy other)
        {
            return new ApparentEnergy(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ApparentEnergy"/> by a constant</summary>
        public new ApparentEnergy Scale(double scaleFactor)
        {
            return new ApparentEnergy(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ApparentEnergy"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ApparentEnergy)other);

        /// <summary>Subtract one <see cref="ApparentEnergy"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ApparentEnergy)other);
        ...
        {
            if(other is ApparentEnergy otherApparentEnergy)
            {
                return Value.CompareTo(otherApparentEnergy.GetValueAs(this.Unit));
            }
        ...
        public override ApparentEnergy ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ApparentEnergyUnit> IQuantity<ApparentEnergyUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ApparentEnergyUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ApparentEnergyUnit unit)
        {
