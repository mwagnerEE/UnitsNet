...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class CoefficientOfThermalExpansion :  QuantityBase, IQuantity<CoefficientOfThermalExpansionUnit>, IEquatable<CoefficientOfThermalExpansion>, IComparable, IComparable<CoefficientOfThermalExpansion>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new CoefficientOfThermalExpansion((QuantityValue)value, (CoefficientOfThermalExpansionUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public CoefficientOfThermalExpansion() : this(0, BaseUnit)
        {
        }
        ...
        public CoefficientOfThermalExpansion(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public CoefficientOfThermalExpansion(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public CoefficientOfThermalExpansion(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new CoefficientOfThermalExpansion(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public CoefficientOfThermalExpansion(QuantityValue value, CoefficientOfThermalExpansionUnit unit) : base(value, BaseDimensions)
        {
        ...
        public CoefficientOfThermalExpansion(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<CoefficientOfThermalExpansionUnit> QuantityInfo => Info;
        ...
        /// </summary>
        public QuantityValue InverseDegreeCelsius => As(CoefficientOfThermalExpansionUnit.InverseDegreeCelsius);
        ...
        /// </summary>
        public QuantityValue InverseDegreeFahrenheit => As(CoefficientOfThermalExpansionUnit.InverseDegreeFahrenheit);

        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="CoefficientOfThermalExpansionUnit.InverseKelvin"/>
        /// </summary>
        public QuantityValue InverseKelvin => As(CoefficientOfThermalExpansionUnit.InverseKelvin);
        ...
        {
            QuantityValue value = (QuantityValue) inversedegreecelsius;
        ...
        {
            QuantityValue value = (QuantityValue) inversedegreefahrenheit;
        ...
        {
            QuantityValue value = (QuantityValue) inversekelvin;
        ...
        {
            return new CoefficientOfThermalExpansion((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="CoefficientOfThermalExpansion"/>.</summary>
        public new CoefficientOfThermalExpansion Negate()
        {
            return new CoefficientOfThermalExpansion(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="CoefficientOfThermalExpansion"/> together</summary>
        public CoefficientOfThermalExpansion Add(CoefficientOfThermalExpansion other)
        {
            return new CoefficientOfThermalExpansion(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="CoefficientOfThermalExpansion"/> from another</summary>
        public CoefficientOfThermalExpansion Subtract(CoefficientOfThermalExpansion other)
        {
            return new CoefficientOfThermalExpansion(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="CoefficientOfThermalExpansion"/> by a constant</summary>
        public new CoefficientOfThermalExpansion Scale(double scaleFactor)
        {
            return new CoefficientOfThermalExpansion(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="CoefficientOfThermalExpansion"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((CoefficientOfThermalExpansion)other);

        /// <summary>Subtract one <see cref="CoefficientOfThermalExpansion"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((CoefficientOfThermalExpansion)other);
        ...
        {
            if(other is CoefficientOfThermalExpansion otherCoefficientOfThermalExpansion)
            {
                return Value.CompareTo(otherCoefficientOfThermalExpansion.GetValueAs(this.Unit));
            }
        ...
        public override CoefficientOfThermalExpansion ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<CoefficientOfThermalExpansionUnit> IQuantity<CoefficientOfThermalExpansionUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<CoefficientOfThermalExpansionUnit>)ToUnit(unitSystem);
