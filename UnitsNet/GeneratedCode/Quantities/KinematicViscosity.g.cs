...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class KinematicViscosity :  QuantityBase, IQuantity<KinematicViscosityUnit>, IEquatable<KinematicViscosity>, IComparable, IComparable<KinematicViscosity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new KinematicViscosity((QuantityValue)value, (KinematicViscosityUnit)unit);
#endif
        ...
        public KinematicViscosity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public KinematicViscosity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public KinematicViscosity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public KinematicViscosity(QuantityValue value, KinematicViscosityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public KinematicViscosity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<KinematicViscosityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) centistokes;
        ...
        {
            QuantityValue value = (QuantityValue) decistokes;
        ...
        {
            QuantityValue value = (QuantityValue) kilostokes;
        ...
        {
            QuantityValue value = (QuantityValue) microstokes;
        ...
        {
            QuantityValue value = (QuantityValue) millistokes;
        ...
        {
            QuantityValue value = (QuantityValue) nanostokes;
        ...
        {
            QuantityValue value = (QuantityValue) squarefeetpersecond;
        ...
        {
            QuantityValue value = (QuantityValue) squaremeterspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) stokes;
        ...
        {
            return new KinematicViscosity((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="KinematicViscosity"/>.</summary>
        public new KinematicViscosity Negate()
        {
            return new KinematicViscosity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="KinematicViscosity"/> together</summary>
        public KinematicViscosity Add(KinematicViscosity other)
        {
            return new KinematicViscosity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="KinematicViscosity"/> from another</summary>
        public KinematicViscosity Subtract(KinematicViscosity other)
        {
            return new KinematicViscosity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="KinematicViscosity"/> by a constant</summary>
        public new KinematicViscosity Scale(double scaleFactor)
        {
            return new KinematicViscosity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="KinematicViscosity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((KinematicViscosity)other);

        /// <summary>Subtract one <see cref="KinematicViscosity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((KinematicViscosity)other);
        ...
        {
            if(other is KinematicViscosity otherKinematicViscosity)
            {
                return Value.CompareTo(otherKinematicViscosity.GetValueAs(this.Unit));
            }
        ...
        public override KinematicViscosity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<KinematicViscosityUnit> IQuantity<KinematicViscosityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<KinematicViscosityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(KinematicViscosityUnit unit)
        {
