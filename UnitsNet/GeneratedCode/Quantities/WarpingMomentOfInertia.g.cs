...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class WarpingMomentOfInertia :  QuantityBase, IQuantity<WarpingMomentOfInertiaUnit>, IEquatable<WarpingMomentOfInertia>, IComparable, IComparable<WarpingMomentOfInertia>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new WarpingMomentOfInertia((QuantityValue)value, (WarpingMomentOfInertiaUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public WarpingMomentOfInertia() : this(0, BaseUnit)
        {
        }
        ...
        public WarpingMomentOfInertia(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public WarpingMomentOfInertia(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public WarpingMomentOfInertia(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new WarpingMomentOfInertia(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public WarpingMomentOfInertia(QuantityValue value, WarpingMomentOfInertiaUnit unit) : base(value, BaseDimensions)
        {
        ...
        public WarpingMomentOfInertia(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<WarpingMomentOfInertiaUnit> QuantityInfo => Info;
        ...
        internal static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<WarpingMomentOfInertia>(WarpingMomentOfInertiaUnit.MeterToTheSixth, WarpingMomentOfInertiaUnit.FootToTheSixth, quantity => new WarpingMomentOfInertia(quantity.Value / QuantityValue.Pow(0.3048, 6), WarpingMomentOfInertiaUnit.FootToTheSixth));
            unitConverter.SetConversionFunction<WarpingMomentOfInertia>(WarpingMomentOfInertiaUnit.MeterToTheSixth, WarpingMomentOfInertiaUnit.InchToTheSixth, quantity => new WarpingMomentOfInertia(quantity.Value / QuantityValue.Pow(2.54e-2, 6), WarpingMomentOfInertiaUnit.InchToTheSixth));
            ...
            unitConverter.SetConversionFunction<WarpingMomentOfInertia>(WarpingMomentOfInertiaUnit.FootToTheSixth, WarpingMomentOfInertiaUnit.MeterToTheSixth, quantity => new WarpingMomentOfInertia(quantity.Value * QuantityValue.Pow(0.3048, 6), WarpingMomentOfInertiaUnit.MeterToTheSixth));
            unitConverter.SetConversionFunction<WarpingMomentOfInertia>(WarpingMomentOfInertiaUnit.InchToTheSixth, WarpingMomentOfInertiaUnit.MeterToTheSixth, quantity => new WarpingMomentOfInertia(quantity.Value * QuantityValue.Pow(2.54e-2, 6), WarpingMomentOfInertiaUnit.MeterToTheSixth));
        ...
        {
            QuantityValue value = (QuantityValue) centimeterstothesixth;
        ...
        {
            QuantityValue value = (QuantityValue) decimeterstothesixth;
        ...
        {
            QuantityValue value = (QuantityValue) feettothesixth;
        ...
        {
            QuantityValue value = (QuantityValue) inchestothesixth;
        ...
        {
            QuantityValue value = (QuantityValue) meterstothesixth;
        ...
        {
            QuantityValue value = (QuantityValue) millimeterstothesixth;
        ...
        {
            return new WarpingMomentOfInertia((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="WarpingMomentOfInertia"/>.</summary>
        public new WarpingMomentOfInertia Negate()
        {
            return new WarpingMomentOfInertia(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="WarpingMomentOfInertia"/> together</summary>
        public WarpingMomentOfInertia Add(WarpingMomentOfInertia other)
        {
            return new WarpingMomentOfInertia(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="WarpingMomentOfInertia"/> from another</summary>
        public WarpingMomentOfInertia Subtract(WarpingMomentOfInertia other)
        {
            return new WarpingMomentOfInertia(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="WarpingMomentOfInertia"/> by a constant</summary>
        public new WarpingMomentOfInertia Scale(double scaleFactor)
        {
            return new WarpingMomentOfInertia(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="WarpingMomentOfInertia"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((WarpingMomentOfInertia)other);

        /// <summary>Subtract one <see cref="WarpingMomentOfInertia"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((WarpingMomentOfInertia)other);
        ...
        {
            if(other is WarpingMomentOfInertia otherWarpingMomentOfInertia)
            {
                return Value.CompareTo(otherWarpingMomentOfInertia.GetValueAs(this.Unit));
            }
        ...
        public override WarpingMomentOfInertia ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<WarpingMomentOfInertiaUnit> IQuantity<WarpingMomentOfInertiaUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<WarpingMomentOfInertiaUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(WarpingMomentOfInertiaUnit unit)
        {
