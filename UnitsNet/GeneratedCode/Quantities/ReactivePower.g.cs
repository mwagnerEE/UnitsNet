...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReactivePower :  QuantityBase, IQuantity<ReactivePowerUnit>, IEquatable<ReactivePower>, IComparable, IComparable<ReactivePower>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ReactivePower((QuantityValue)value, (ReactivePowerUnit)unit);
#endif
        ...
        public ReactivePower(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReactivePower(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReactivePower(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReactivePower(QuantityValue value, ReactivePowerUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ReactivePower(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ReactivePowerUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) gigavoltamperesreactive;
        ...
        {
            QuantityValue value = (QuantityValue) kilovoltamperesreactive;
        ...
        {
            QuantityValue value = (QuantityValue) megavoltamperesreactive;
        ...
        {
            QuantityValue value = (QuantityValue) voltamperesreactive;
        ...
        {
            return new ReactivePower((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ReactivePower"/>.</summary>
        public new ReactivePower Negate()
        {
            return new ReactivePower(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ReactivePower"/> together</summary>
        public ReactivePower Add(ReactivePower other)
        {
            return new ReactivePower(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ReactivePower"/> from another</summary>
        public ReactivePower Subtract(ReactivePower other)
        {
            return new ReactivePower(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ReactivePower"/> by a constant</summary>
        public new ReactivePower Scale(double scaleFactor)
        {
            return new ReactivePower(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ReactivePower"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ReactivePower)other);

        /// <summary>Subtract one <see cref="ReactivePower"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ReactivePower)other);
        ...
        {
            if(other is ReactivePower otherReactivePower)
            {
                return Value.CompareTo(otherReactivePower.GetValueAs(this.Unit));
            }
        ...
        public override ReactivePower ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ReactivePowerUnit> IQuantity<ReactivePowerUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ReactivePowerUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ReactivePowerUnit unit)
        {
