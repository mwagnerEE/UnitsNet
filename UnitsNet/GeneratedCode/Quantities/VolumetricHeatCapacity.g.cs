...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class VolumetricHeatCapacity :  QuantityBase, IQuantity<VolumetricHeatCapacityUnit>, IEquatable<VolumetricHeatCapacity>, IComparable, IComparable<VolumetricHeatCapacity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new VolumetricHeatCapacity((QuantityValue)value, (VolumetricHeatCapacityUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public VolumetricHeatCapacity() : this(0, BaseUnit)
        {
        }
        ...
        public VolumetricHeatCapacity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumetricHeatCapacity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumetricHeatCapacity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumetricHeatCapacity(QuantityValue value, VolumetricHeatCapacityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public VolumetricHeatCapacity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<VolumetricHeatCapacityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) btuspercubicfootdegreefahrenheit;
        ...
        {
            QuantityValue value = (QuantityValue) caloriespercubiccentimeterdegreecelsius;
        ...
        {
            QuantityValue value = (QuantityValue) joulespercubicmeterdegreecelsius;
        ...
        {
            QuantityValue value = (QuantityValue) joulespercubicmeterkelvin;
        ...
        {
            QuantityValue value = (QuantityValue) kilocaloriespercubiccentimeterdegreecelsius;
        ...
        {
            QuantityValue value = (QuantityValue) kilojoulespercubicmeterdegreecelsius;
        ...
        {
            QuantityValue value = (QuantityValue) kilojoulespercubicmeterkelvin;
        ...
        {
            QuantityValue value = (QuantityValue) megajoulespercubicmeterdegreecelsius;
        ...
        {
            QuantityValue value = (QuantityValue) megajoulespercubicmeterkelvin;
        ...
        {
            return new VolumetricHeatCapacity((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="VolumetricHeatCapacity"/>.</summary>
        public new VolumetricHeatCapacity Negate()
        {
            return new VolumetricHeatCapacity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="VolumetricHeatCapacity"/> together</summary>
        public VolumetricHeatCapacity Add(VolumetricHeatCapacity other)
        {
            return new VolumetricHeatCapacity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="VolumetricHeatCapacity"/> from another</summary>
        public VolumetricHeatCapacity Subtract(VolumetricHeatCapacity other)
        {
            return new VolumetricHeatCapacity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="VolumetricHeatCapacity"/> by a constant</summary>
        public new VolumetricHeatCapacity Scale(double scaleFactor)
        {
            return new VolumetricHeatCapacity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="VolumetricHeatCapacity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((VolumetricHeatCapacity)other);

        /// <summary>Subtract one <see cref="VolumetricHeatCapacity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((VolumetricHeatCapacity)other);
        ...
        {
            if(other is VolumetricHeatCapacity otherVolumetricHeatCapacity)
            {
                return Value.CompareTo(otherVolumetricHeatCapacity.GetValueAs(this.Unit));
            }
        ...
        public override VolumetricHeatCapacity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<VolumetricHeatCapacityUnit> IQuantity<VolumetricHeatCapacityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<VolumetricHeatCapacityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(VolumetricHeatCapacityUnit unit)
        {
