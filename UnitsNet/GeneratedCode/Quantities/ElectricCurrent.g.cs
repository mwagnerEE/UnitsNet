...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class ElectricCurrent :  QuantityBase, IQuantity<ElectricCurrentUnit>, IEquatable<ElectricCurrent>, IComparable, IComparable<ElectricCurrent>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ElectricCurrent((QuantityValue)value, (ElectricCurrentUnit)unit);
#endif
        ...
        public ElectricCurrent(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricCurrent(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricCurrent(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricCurrent(QuantityValue value, ElectricCurrentUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ElectricCurrent(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ElectricCurrentUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) amperes;
        ...
        {
            QuantityValue value = (QuantityValue) centiamperes;
        ...
        {
            QuantityValue value = (QuantityValue) kiloamperes;
        ...
        {
            QuantityValue value = (QuantityValue) megaamperes;
        ...
        {
            QuantityValue value = (QuantityValue) microamperes;
        ...
        {
            QuantityValue value = (QuantityValue) milliamperes;
        ...
        {
            QuantityValue value = (QuantityValue) nanoamperes;
        ...
        {
            QuantityValue value = (QuantityValue) picoamperes;
        ...
        {
            return new ElectricCurrent((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ElectricCurrent"/>.</summary>
        public new ElectricCurrent Negate()
        {
            return new ElectricCurrent(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ElectricCurrent"/> together</summary>
        public ElectricCurrent Add(ElectricCurrent other)
        {
            return new ElectricCurrent(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ElectricCurrent"/> from another</summary>
        public ElectricCurrent Subtract(ElectricCurrent other)
        {
            return new ElectricCurrent(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ElectricCurrent"/> by a constant</summary>
        public new ElectricCurrent Scale(double scaleFactor)
        {
            return new ElectricCurrent(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ElectricCurrent"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ElectricCurrent)other);

        /// <summary>Subtract one <see cref="ElectricCurrent"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ElectricCurrent)other);
        ...
        {
            if(other is ElectricCurrent otherElectricCurrent)
            {
                return Value.CompareTo(otherElectricCurrent.GetValueAs(this.Unit));
            }
        ...
        public override ElectricCurrent ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ElectricCurrentUnit> IQuantity<ElectricCurrentUnit>.ToUnit(ElectricCurrentUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<ElectricCurrentUnit> IQuantity<ElectricCurrentUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ElectricCurrentUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ElectricCurrentUnit unit)
        {
