...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemperatureGradient :  QuantityBase, IQuantity<TemperatureGradientUnit>, IEquatable<TemperatureGradient>, IComparable, IComparable<TemperatureGradient>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new TemperatureGradient((QuantityValue)value, (TemperatureGradientUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public TemperatureGradient() : this(0, BaseUnit)
        {
        }
        ...
        public TemperatureGradient(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureGradient(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureGradient(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new TemperatureGradient(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureGradient(QuantityValue value, TemperatureGradientUnit unit) : base(value, BaseDimensions)
        {
        ...
        public TemperatureGradient(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<TemperatureGradientUnit> QuantityInfo => Info;
        ...
        /// </summary>
        public QuantityValue DegreesCelciusPerKilometer => As(TemperatureGradientUnit.DegreeCelsiusPerKilometer);

        /// <summary>
        ///     Gets a <see cref="double"/> value of this quantity converted into <see cref="TemperatureGradientUnit.DegreeCelsiusPerMeter"/>
        /// </summary>
        public QuantityValue DegreesCelciusPerMeter => As(TemperatureGradientUnit.DegreeCelsiusPerMeter);
        ...
        {
            QuantityValue value = (QuantityValue) degreescelciuspermeter;
        ...
        {
            QuantityValue value = (QuantityValue) degreesfahrenheitperfoot;
        ...
        {
            QuantityValue value = (QuantityValue) kelvinspermeter;
        ...
        {
            return new TemperatureGradient((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="TemperatureGradient"/>.</summary>
        public new TemperatureGradient Negate()
        {
            return new TemperatureGradient(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="TemperatureGradient"/> together</summary>
        public TemperatureGradient Add(TemperatureGradient other)
        {
            return new TemperatureGradient(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="TemperatureGradient"/> from another</summary>
        public TemperatureGradient Subtract(TemperatureGradient other)
        {
            return new TemperatureGradient(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="TemperatureGradient"/> by a constant</summary>
        public new TemperatureGradient Scale(double scaleFactor)
        {
            return new TemperatureGradient(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="TemperatureGradient"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((TemperatureGradient)other);

        /// <summary>Subtract one <see cref="TemperatureGradient"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((TemperatureGradient)other);
        ...
        {
            if(other is TemperatureGradient otherTemperatureGradient)
            {
                return Value.CompareTo(otherTemperatureGradient.GetValueAs(this.Unit));
            }
        ...
        public override TemperatureGradient ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<TemperatureGradientUnit> IQuantity<TemperatureGradientUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<TemperatureGradientUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(TemperatureGradientUnit unit)
        {
