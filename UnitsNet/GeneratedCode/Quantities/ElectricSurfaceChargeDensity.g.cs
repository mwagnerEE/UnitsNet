...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class ElectricSurfaceChargeDensity :  QuantityBase, IQuantity<ElectricSurfaceChargeDensityUnit>, IEquatable<ElectricSurfaceChargeDensity>, IComparable, IComparable<ElectricSurfaceChargeDensity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ElectricSurfaceChargeDensity((QuantityValue)value, (ElectricSurfaceChargeDensityUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public ElectricSurfaceChargeDensity() : this(0, BaseUnit)
        {
        }
        ...
        public ElectricSurfaceChargeDensity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricSurfaceChargeDensity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricSurfaceChargeDensity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new ElectricSurfaceChargeDensity(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricSurfaceChargeDensity(QuantityValue value, ElectricSurfaceChargeDensityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ElectricSurfaceChargeDensity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ElectricSurfaceChargeDensityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) coulombspersquarecentimeter;
        ...
        {
            QuantityValue value = (QuantityValue) coulombspersquareinch;
        ...
        {
            QuantityValue value = (QuantityValue) coulombspersquaremeter;
        ...
        {
            return new ElectricSurfaceChargeDensity((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ElectricSurfaceChargeDensity"/>.</summary>
        public new ElectricSurfaceChargeDensity Negate()
        {
            return new ElectricSurfaceChargeDensity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ElectricSurfaceChargeDensity"/> together</summary>
        public ElectricSurfaceChargeDensity Add(ElectricSurfaceChargeDensity other)
        {
            return new ElectricSurfaceChargeDensity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ElectricSurfaceChargeDensity"/> from another</summary>
        public ElectricSurfaceChargeDensity Subtract(ElectricSurfaceChargeDensity other)
        {
            return new ElectricSurfaceChargeDensity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ElectricSurfaceChargeDensity"/> by a constant</summary>
        public new ElectricSurfaceChargeDensity Scale(double scaleFactor)
        {
            return new ElectricSurfaceChargeDensity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ElectricSurfaceChargeDensity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ElectricSurfaceChargeDensity)other);

        /// <summary>Subtract one <see cref="ElectricSurfaceChargeDensity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ElectricSurfaceChargeDensity)other);
        ...
        {
            if(other is ElectricSurfaceChargeDensity otherElectricSurfaceChargeDensity)
            {
                return Value.CompareTo(otherElectricSurfaceChargeDensity.GetValueAs(this.Unit));
            }
        ...
        public override ElectricSurfaceChargeDensity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ElectricSurfaceChargeDensityUnit> IQuantity<ElectricSurfaceChargeDensityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ElectricSurfaceChargeDensityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ElectricSurfaceChargeDensityUnit unit)
        {
