...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class LuminousIntensity :  QuantityBase, IQuantity<LuminousIntensityUnit>, IEquatable<LuminousIntensity>, IComparable, IComparable<LuminousIntensity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new LuminousIntensity((QuantityValue)value, (LuminousIntensityUnit)unit);
#endif
        ...
        public LuminousIntensity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LuminousIntensity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LuminousIntensity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LuminousIntensity(QuantityValue value, LuminousIntensityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public LuminousIntensity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<LuminousIntensityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) candela;
        ...
        {
            return new LuminousIntensity((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="LuminousIntensity"/>.</summary>
        public new LuminousIntensity Negate()
        {
            return new LuminousIntensity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="LuminousIntensity"/> together</summary>
        public LuminousIntensity Add(LuminousIntensity other)
        {
            return new LuminousIntensity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="LuminousIntensity"/> from another</summary>
        public LuminousIntensity Subtract(LuminousIntensity other)
        {
            return new LuminousIntensity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="LuminousIntensity"/> by a constant</summary>
        public new LuminousIntensity Scale(double scaleFactor)
        {
            return new LuminousIntensity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="LuminousIntensity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((LuminousIntensity)other);

        /// <summary>Subtract one <see cref="LuminousIntensity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((LuminousIntensity)other);
        ...
        {
            if(other is LuminousIntensity otherLuminousIntensity)
            {
                return Value.CompareTo(otherLuminousIntensity.GetValueAs(this.Unit));
            }
        ...
        public override LuminousIntensity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<LuminousIntensityUnit> IQuantity<LuminousIntensityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<LuminousIntensityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(LuminousIntensityUnit unit)
        {
