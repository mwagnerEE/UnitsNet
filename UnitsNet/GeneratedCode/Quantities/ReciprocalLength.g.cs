...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class ReciprocalLength :  QuantityBase, IQuantity<ReciprocalLengthUnit>, IEquatable<ReciprocalLength>, IComparable, IComparable<ReciprocalLength>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ReciprocalLength((QuantityValue)value, (ReciprocalLengthUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public ReciprocalLength() : this(0, BaseUnit)
        {
        }
        ...
        public ReciprocalLength(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReciprocalLength(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReciprocalLength(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new ReciprocalLength(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ReciprocalLength(QuantityValue value, ReciprocalLengthUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ReciprocalLength(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ReciprocalLengthUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) inversecentimeters;
        ...
        {
            QuantityValue value = (QuantityValue) inversefeet;
        ...
        {
            QuantityValue value = (QuantityValue) inverseinches;
        ...
        {
            QuantityValue value = (QuantityValue) inversemeters;
        ...
        {
            QuantityValue value = (QuantityValue) inversemicroinches;
        ...
        {
            QuantityValue value = (QuantityValue) inversemils;
        ...
        {
            QuantityValue value = (QuantityValue) inversemiles;
        ...
        {
            QuantityValue value = (QuantityValue) inversemillimeters;
        ...
        {
            QuantityValue value = (QuantityValue) inverseussurveyfeet;
        ...
        {
            QuantityValue value = (QuantityValue) inverseyards;
        ...
        {
            return new ReciprocalLength((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ReciprocalLength"/>.</summary>
        public new ReciprocalLength Negate()
        {
            return new ReciprocalLength(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ReciprocalLength"/> together</summary>
        public ReciprocalLength Add(ReciprocalLength other)
        {
            return new ReciprocalLength(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ReciprocalLength"/> from another</summary>
        public ReciprocalLength Subtract(ReciprocalLength other)
        {
            return new ReciprocalLength(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ReciprocalLength"/> by a constant</summary>
        public new ReciprocalLength Scale(double scaleFactor)
        {
            return new ReciprocalLength(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ReciprocalLength"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ReciprocalLength)other);

        /// <summary>Subtract one <see cref="ReciprocalLength"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ReciprocalLength)other);
        ...
        {
            if(other is ReciprocalLength otherReciprocalLength)
            {
                return Value.CompareTo(otherReciprocalLength.GetValueAs(this.Unit));
            }
        ...
        public override ReciprocalLength ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ReciprocalLengthUnit> IQuantity<ReciprocalLengthUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ReciprocalLengthUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ReciprocalLengthUnit unit)
        {
