...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class ElectricField :  QuantityBase, IQuantity<ElectricFieldUnit>, IEquatable<ElectricField>, IComparable, IComparable<ElectricField>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ElectricField((QuantityValue)value, (ElectricFieldUnit)unit);
#endif
        ...
        public ElectricField(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricField(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricField(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricField(QuantityValue value, ElectricFieldUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ElectricField(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ElectricFieldUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) voltspermeter;
        ...
        {
            return new ElectricField((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="ElectricField"/>.</summary>
        public new ElectricField Negate()
        {
            return new ElectricField(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ElectricField"/> together</summary>
        public ElectricField Add(ElectricField other)
        {
            return new ElectricField(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ElectricField"/> from another</summary>
        public ElectricField Subtract(ElectricField other)
        {
            return new ElectricField(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ElectricField"/> by a constant</summary>
        public new ElectricField Scale(double scaleFactor)
        {
            return new ElectricField(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ElectricField"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ElectricField)other);

        /// <summary>Subtract one <see cref="ElectricField"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ElectricField)other);
        ...
        {
            if(other is ElectricField otherElectricField)
            {
                return Value.CompareTo(otherElectricField.GetValueAs(this.Unit));
            }
        ...
        public override ElectricField ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ElectricFieldUnit> IQuantity<ElectricFieldUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ElectricFieldUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(ElectricFieldUnit unit)
        {
