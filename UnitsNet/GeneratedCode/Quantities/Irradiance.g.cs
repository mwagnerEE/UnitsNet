...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class Irradiance :  QuantityBase, IQuantity<IrradianceUnit>, IEquatable<Irradiance>, IComparable, IComparable<Irradiance>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new Irradiance((QuantityValue)value, (IrradianceUnit)unit);
#endif
        ...
        public Irradiance(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Irradiance(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Irradiance(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Irradiance(QuantityValue value, IrradianceUnit unit) : base(value, BaseDimensions)
        {
        ...
        public Irradiance(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<IrradianceUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) kilowattspersquarecentimeter;
        ...
        {
            QuantityValue value = (QuantityValue) megawattspersquarecentimeter;
        ...
        {
            QuantityValue value = (QuantityValue) megawattspersquaremeter;
        ...
        {
            QuantityValue value = (QuantityValue) microwattspersquarecentimeter;
        ...
        {
            QuantityValue value = (QuantityValue) milliwattspersquarecentimeter;
        ...
        {
            QuantityValue value = (QuantityValue) nanowattspersquarecentimeter;
        ...
        {
            QuantityValue value = (QuantityValue) picowattspersquarecentimeter;
        ...
        {
            QuantityValue value = (QuantityValue) picowattspersquaremeter;
        ...
        {
            QuantityValue value = (QuantityValue) wattspersquarecentimeter;
        ...
        {
            return new Irradiance((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="Irradiance"/>.</summary>
        public new Irradiance Negate()
        {
            return new Irradiance(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="Irradiance"/> together</summary>
        public Irradiance Add(Irradiance other)
        {
            return new Irradiance(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="Irradiance"/> from another</summary>
        public Irradiance Subtract(Irradiance other)
        {
            return new Irradiance(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="Irradiance"/> by a constant</summary>
        public new Irradiance Scale(double scaleFactor)
        {
            return new Irradiance(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="Irradiance"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((Irradiance)other);

        /// <summary>Subtract one <see cref="Irradiance"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((Irradiance)other);
        ...
        {
            if(other is Irradiance otherIrradiance)
            {
                return Value.CompareTo(otherIrradiance.GetValueAs(this.Unit));
            }
        ...
        public override Irradiance ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<IrradianceUnit> IQuantity<IrradianceUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<IrradianceUnit>)ToUnit(unitSystem);
