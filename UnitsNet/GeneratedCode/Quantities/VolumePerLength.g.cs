...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class VolumePerLength :  QuantityBase, IQuantity<VolumePerLengthUnit>, IEquatable<VolumePerLength>, IComparable, IComparable<VolumePerLength>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new VolumePerLength((QuantityValue)value, (VolumePerLengthUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public VolumePerLength() : this(0, BaseUnit)
        {
        }
        ...
        public VolumePerLength(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumePerLength(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumePerLength(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new VolumePerLength(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumePerLength(QuantityValue value, VolumePerLengthUnit unit) : base(value, BaseDimensions)
        {
        ...
        public VolumePerLength(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<VolumePerLengthUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) cubicmeterspermeter;
        ...
        {
            QuantityValue value = (QuantityValue) cubicyardsperfoot;
        ...
        {
            QuantityValue value = (QuantityValue) cubicyardsperussurveyfoot;
        ...
        {
            QuantityValue value = (QuantityValue) litersperkilometer;
        ...
        {
            QuantityValue value = (QuantityValue) literspermeter;
        ...
        {
            QuantityValue value = (QuantityValue) literspermillimeter;
        ...
        {
            QuantityValue value = (QuantityValue) oilbarrelsperfoot;
        ...
        {
            return new VolumePerLength((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="VolumePerLength"/>.</summary>
        public new VolumePerLength Negate()
        {
            return new VolumePerLength(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="VolumePerLength"/> together</summary>
        public VolumePerLength Add(VolumePerLength other)
        {
            return new VolumePerLength(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="VolumePerLength"/> from another</summary>
        public VolumePerLength Subtract(VolumePerLength other)
        {
            return new VolumePerLength(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="VolumePerLength"/> by a constant</summary>
        public new VolumePerLength Scale(double scaleFactor)
        {
            return new VolumePerLength(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="VolumePerLength"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((VolumePerLength)other);

        /// <summary>Subtract one <see cref="VolumePerLength"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((VolumePerLength)other);
        ...
        {
            if(other is VolumePerLength otherVolumePerLength)
            {
                return Value.CompareTo(otherVolumePerLength.GetValueAs(this.Unit));
            }
        ...
        public override VolumePerLength ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<VolumePerLengthUnit> IQuantity<VolumePerLengthUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<VolumePerLengthUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(VolumePerLengthUnit unit)
        {
