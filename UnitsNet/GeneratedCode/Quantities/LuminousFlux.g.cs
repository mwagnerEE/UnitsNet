...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class LuminousFlux :  QuantityBase, IQuantity<LuminousFluxUnit>, IEquatable<LuminousFlux>, IComparable, IComparable<LuminousFlux>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new LuminousFlux((QuantityValue)value, (LuminousFluxUnit)unit);
#endif
        ...
        public LuminousFlux(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LuminousFlux(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LuminousFlux(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public LuminousFlux(QuantityValue value, LuminousFluxUnit unit) : base(value, BaseDimensions)
        {
        ...
        public LuminousFlux(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<LuminousFluxUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) lumens;
        ...
        {
            return new LuminousFlux((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="LuminousFlux"/>.</summary>
        public new LuminousFlux Negate()
        {
            return new LuminousFlux(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="LuminousFlux"/> together</summary>
        public LuminousFlux Add(LuminousFlux other)
        {
            return new LuminousFlux(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="LuminousFlux"/> from another</summary>
        public LuminousFlux Subtract(LuminousFlux other)
        {
            return new LuminousFlux(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="LuminousFlux"/> by a constant</summary>
        public new LuminousFlux Scale(double scaleFactor)
        {
            return new LuminousFlux(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="LuminousFlux"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((LuminousFlux)other);

        /// <summary>Subtract one <see cref="LuminousFlux"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((LuminousFlux)other);
        ...
        {
            if(other is LuminousFlux otherLuminousFlux)
            {
                return Value.CompareTo(otherLuminousFlux.GetValueAs(this.Unit));
            }
        ...
        public override LuminousFlux ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<LuminousFluxUnit> IQuantity<LuminousFluxUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<LuminousFluxUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(LuminousFluxUnit unit)
        {
