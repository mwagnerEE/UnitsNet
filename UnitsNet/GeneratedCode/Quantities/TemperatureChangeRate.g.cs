...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemperatureChangeRate :  QuantityBase, IQuantity<TemperatureChangeRateUnit>, IEquatable<TemperatureChangeRate>, IComparable, IComparable<TemperatureChangeRate>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new TemperatureChangeRate((QuantityValue)value, (TemperatureChangeRateUnit)unit);
#endif
        ...
        public TemperatureChangeRate(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureChangeRate(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureChangeRate(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureChangeRate(QuantityValue value, TemperatureChangeRateUnit unit) : base(value, BaseDimensions)
        {
        ...
        public TemperatureChangeRate(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<TemperatureChangeRateUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) centidegreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) decadegreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) decidegreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) degreescelsiusperminute;
        ...
        {
            QuantityValue value = (QuantityValue) degreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) hectodegreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) kilodegreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) microdegreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) millidegreescelsiuspersecond;
        ...
        {
            QuantityValue value = (QuantityValue) nanodegreescelsiuspersecond;
        ...
        {
            return new TemperatureChangeRate((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="TemperatureChangeRate"/>.</summary>
        public new TemperatureChangeRate Negate()
        {
            return new TemperatureChangeRate(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="TemperatureChangeRate"/> together</summary>
        public TemperatureChangeRate Add(TemperatureChangeRate other)
        {
            return new TemperatureChangeRate(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="TemperatureChangeRate"/> from another</summary>
        public TemperatureChangeRate Subtract(TemperatureChangeRate other)
        {
            return new TemperatureChangeRate(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="TemperatureChangeRate"/> by a constant</summary>
        public new TemperatureChangeRate Scale(double scaleFactor)
        {
            return new TemperatureChangeRate(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="TemperatureChangeRate"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((TemperatureChangeRate)other);

        /// <summary>Subtract one <see cref="TemperatureChangeRate"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((TemperatureChangeRate)other);
        ...
        {
            if(other is TemperatureChangeRate otherTemperatureChangeRate)
            {
                return Value.CompareTo(otherTemperatureChangeRate.GetValueAs(this.Unit));
            }
        ...
        IQuantity IQuantity.ToUnit(Enum unit, UnitConverter unitConverter)
        {
            ...
            return ToUnit(unitAsTemperatureChangeRateUnit, unitConverter);
        }

        /// <inheritdoc cref="IQuantity.ToUnit(UnitSystem)"/>
#if NET5_0_OR_GREATER
        public override TemperatureChangeRate ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<TemperatureChangeRateUnit> IQuantity<TemperatureChangeRateUnit>.ToUnit(TemperatureChangeRateUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<TemperatureChangeRateUnit> IQuantity<TemperatureChangeRateUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<TemperatureChangeRateUnit>)ToUnit(unitSystem);
