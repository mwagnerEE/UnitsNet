...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class Permeability :  QuantityBase, IQuantity<PermeabilityUnit>, IEquatable<Permeability>, IComparable, IComparable<Permeability>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new Permeability((QuantityValue)value, (PermeabilityUnit)unit);
#endif
        ...
        public Permeability(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Permeability(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Permeability(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Permeability(QuantityValue value, PermeabilityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public Permeability(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<PermeabilityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) henriespermeter;
        ...
        {
            return new Permeability((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="Permeability"/>.</summary>
        public new Permeability Negate()
        {
            return new Permeability(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="Permeability"/> together</summary>
        public Permeability Add(Permeability other)
        {
            return new Permeability(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="Permeability"/> from another</summary>
        public Permeability Subtract(Permeability other)
        {
            return new Permeability(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="Permeability"/> by a constant</summary>
        public new Permeability Scale(double scaleFactor)
        {
            return new Permeability(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="Permeability"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((Permeability)other);

        /// <summary>Subtract one <see cref="Permeability"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((Permeability)other);
        ...
        {
            if(other is Permeability otherPermeability)
            {
                return Value.CompareTo(otherPermeability.GetValueAs(this.Unit));
            }
        ...
        public override Permeability ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<PermeabilityUnit> IQuantity<PermeabilityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<PermeabilityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(PermeabilityUnit unit)
        {
