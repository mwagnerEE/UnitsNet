...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class Illuminance :  QuantityBase, IQuantity<IlluminanceUnit>, IEquatable<Illuminance>, IComparable, IComparable<Illuminance>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new Illuminance((QuantityValue)value, (IlluminanceUnit)unit);
#endif
        ...
        public Illuminance(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Illuminance(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Illuminance(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Illuminance(QuantityValue value, IlluminanceUnit unit) : base(value, BaseDimensions)
        {
        ...
        public Illuminance(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<IlluminanceUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) kilolux;
        ...
        {
            QuantityValue value = (QuantityValue) lux;
        ...
        {
            QuantityValue value = (QuantityValue) megalux;
        ...
        {
            QuantityValue value = (QuantityValue) millilux;
        ...
        {
            return new Illuminance((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="Illuminance"/>.</summary>
        public new Illuminance Negate()
        {
            return new Illuminance(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="Illuminance"/> together</summary>
        public Illuminance Add(Illuminance other)
        {
            return new Illuminance(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="Illuminance"/> from another</summary>
        public Illuminance Subtract(Illuminance other)
        {
            return new Illuminance(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="Illuminance"/> by a constant</summary>
        public new Illuminance Scale(double scaleFactor)
        {
            return new Illuminance(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="Illuminance"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((Illuminance)other);

        /// <summary>Subtract one <see cref="Illuminance"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((Illuminance)other);
        ...
        {
            if(other is Illuminance otherIlluminance)
            {
                return Value.CompareTo(otherIlluminance.GetValueAs(this.Unit));
            }
        ...
        public override Illuminance ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<IlluminanceUnit> IQuantity<IlluminanceUnit>.ToUnit(IlluminanceUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<IlluminanceUnit> IQuantity<IlluminanceUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<IlluminanceUnit>)ToUnit(unitSystem);
