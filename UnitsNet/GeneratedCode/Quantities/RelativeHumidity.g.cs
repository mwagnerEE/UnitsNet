...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class RelativeHumidity :  QuantityBase, IQuantity<RelativeHumidityUnit>, IEquatable<RelativeHumidity>, IComparable, IComparable<RelativeHumidity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new RelativeHumidity((QuantityValue)value, (RelativeHumidityUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public RelativeHumidity() : this(0, BaseUnit)
        {
        }
        ...
        public RelativeHumidity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public RelativeHumidity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public RelativeHumidity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public RelativeHumidity(QuantityValue value, RelativeHumidityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public RelativeHumidity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<RelativeHumidityUnit> QuantityInfo => Info;
        ...
        /// <summary>Negate the <see cref="RelativeHumidity"/>.</summary>
        public new RelativeHumidity Negate()
        {
            return new RelativeHumidity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="RelativeHumidity"/> together</summary>
        public RelativeHumidity Add(RelativeHumidity other)
        {
            return new RelativeHumidity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="RelativeHumidity"/> from another</summary>
        public RelativeHumidity Subtract(RelativeHumidity other)
        {
            return new RelativeHumidity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="RelativeHumidity"/> by a constant</summary>
        public new RelativeHumidity Scale(double scaleFactor)
        {
            return new RelativeHumidity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="RelativeHumidity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((RelativeHumidity)other);

        /// <summary>Subtract one <see cref="RelativeHumidity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((RelativeHumidity)other);
        ...
        {
            if(other is RelativeHumidity otherRelativeHumidity)
            {
                return Value.CompareTo(otherRelativeHumidity.GetValueAs(this.Unit));
            }
        ...
        IQuantity IQuantity.ToUnit(Enum unit, UnitConverter unitConverter)
        {
            ...
            return ToUnit(unitAsRelativeHumidityUnit, unitConverter);
        }

        /// <inheritdoc cref="IQuantity.ToUnit(UnitSystem)"/>
#if NET5_0_OR_GREATER
        public override RelativeHumidity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<RelativeHumidityUnit> IQuantity<RelativeHumidityUnit>.ToUnit(RelativeHumidityUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<RelativeHumidityUnit> IQuantity<RelativeHumidityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<RelativeHumidityUnit>)ToUnit(unitSystem);
