...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class ThermalConductivity :  QuantityBase, IQuantity<ThermalConductivityUnit>, IEquatable<ThermalConductivity>, IComparable, IComparable<ThermalConductivity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ThermalConductivity((QuantityValue)value, (ThermalConductivityUnit)unit);
#endif
        ...
        public ThermalConductivity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ThermalConductivity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ThermalConductivity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ThermalConductivity(QuantityValue value, ThermalConductivityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ThermalConductivity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ThermalConductivityUnit> QuantityInfo => Info;
        ...
        /// <summary>Negate the <see cref="ThermalConductivity"/>.</summary>
        public new ThermalConductivity Negate()
        {
            return new ThermalConductivity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ThermalConductivity"/> together</summary>
        public ThermalConductivity Add(ThermalConductivity other)
        {
            return new ThermalConductivity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ThermalConductivity"/> from another</summary>
        public ThermalConductivity Subtract(ThermalConductivity other)
        {
            return new ThermalConductivity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ThermalConductivity"/> by a constant</summary>
        public new ThermalConductivity Scale(double scaleFactor)
        {
            return new ThermalConductivity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ThermalConductivity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ThermalConductivity)other);

        /// <summary>Subtract one <see cref="ThermalConductivity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ThermalConductivity)other);
        ...
        {
            if(other is ThermalConductivity otherThermalConductivity)
            {
                return Value.CompareTo(otherThermalConductivity.GetValueAs(this.Unit));
            }
        ...
        IQuantity IQuantity.ToUnit(Enum unit, UnitConverter unitConverter)
        {
            ...
            return ToUnit(unitAsThermalConductivityUnit, unitConverter);
        }

        /// <inheritdoc cref="IQuantity.ToUnit(UnitSystem)"/>
#if NET5_0_OR_GREATER
        public override ThermalConductivity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ThermalConductivityUnit> IQuantity<ThermalConductivityUnit>.ToUnit(ThermalConductivityUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<ThermalConductivityUnit> IQuantity<ThermalConductivityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ThermalConductivityUnit>)ToUnit(unitSystem);
