...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class MagneticFlux :  QuantityBase, IQuantity<MagneticFluxUnit>, IEquatable<MagneticFlux>, IComparable, IComparable<MagneticFlux>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new MagneticFlux((QuantityValue)value, (MagneticFluxUnit)unit);
#endif
        ...
        public MagneticFlux(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public MagneticFlux(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public MagneticFlux(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public MagneticFlux(QuantityValue value, MagneticFluxUnit unit) : base(value, BaseDimensions)
        {
        ...
        public MagneticFlux(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<MagneticFluxUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) webers;
        ...
        {
            return new MagneticFlux((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="MagneticFlux"/>.</summary>
        public new MagneticFlux Negate()
        {
            return new MagneticFlux(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="MagneticFlux"/> together</summary>
        public MagneticFlux Add(MagneticFlux other)
        {
            return new MagneticFlux(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="MagneticFlux"/> from another</summary>
        public MagneticFlux Subtract(MagneticFlux other)
        {
            return new MagneticFlux(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="MagneticFlux"/> by a constant</summary>
        public new MagneticFlux Scale(double scaleFactor)
        {
            return new MagneticFlux(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="MagneticFlux"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((MagneticFlux)other);

        /// <summary>Subtract one <see cref="MagneticFlux"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((MagneticFlux)other);
        ...
        {
            if(other is MagneticFlux otherMagneticFlux)
            {
                return Value.CompareTo(otherMagneticFlux.GetValueAs(this.Unit));
            }
        ...
        public override MagneticFlux ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<MagneticFluxUnit> IQuantity<MagneticFluxUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<MagneticFluxUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(MagneticFluxUnit unit)
        {
