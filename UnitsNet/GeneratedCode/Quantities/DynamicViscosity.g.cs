...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class DynamicViscosity :  QuantityBase, IQuantity<DynamicViscosityUnit>, IEquatable<DynamicViscosity>, IComparable, IComparable<DynamicViscosity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new DynamicViscosity((QuantityValue)value, (DynamicViscosityUnit)unit);
#endif
        ...
        public DynamicViscosity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public DynamicViscosity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public DynamicViscosity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public DynamicViscosity(QuantityValue value, DynamicViscosityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public DynamicViscosity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<DynamicViscosityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) centipoise;
        ...
        {
            QuantityValue value = (QuantityValue) micropascalseconds;
        ...
        {
            QuantityValue value = (QuantityValue) millipascalseconds;
        ...
        {
            QuantityValue value = (QuantityValue) newtonsecondspermetersquared;
        ...
        {
            QuantityValue value = (QuantityValue) pascalseconds;
        ...
        {
            QuantityValue value = (QuantityValue) poise;
        ...
        {
            QuantityValue value = (QuantityValue) poundsforcesecondpersquarefoot;
        ...
        {
            QuantityValue value = (QuantityValue) poundsforcesecondpersquareinch;
        ...
        {
            QuantityValue value = (QuantityValue) poundsperfootsecond;
        ...
        {
            QuantityValue value = (QuantityValue) reyns;
        ...
        {
            return new DynamicViscosity((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="DynamicViscosity"/>.</summary>
        public new DynamicViscosity Negate()
        {
            return new DynamicViscosity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="DynamicViscosity"/> together</summary>
        public DynamicViscosity Add(DynamicViscosity other)
        {
            return new DynamicViscosity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="DynamicViscosity"/> from another</summary>
        public DynamicViscosity Subtract(DynamicViscosity other)
        {
            return new DynamicViscosity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="DynamicViscosity"/> by a constant</summary>
        public new DynamicViscosity Scale(double scaleFactor)
        {
            return new DynamicViscosity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="DynamicViscosity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((DynamicViscosity)other);

        /// <summary>Subtract one <see cref="DynamicViscosity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((DynamicViscosity)other);
        ...
        {
            if(other is DynamicViscosity otherDynamicViscosity)
            {
                return Value.CompareTo(otherDynamicViscosity.GetValueAs(this.Unit));
            }
        ...
        public override DynamicViscosity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<DynamicViscosityUnit> IQuantity<DynamicViscosityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<DynamicViscosityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(DynamicViscosityUnit unit)
        {
