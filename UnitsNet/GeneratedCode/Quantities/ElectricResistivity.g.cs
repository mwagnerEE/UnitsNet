...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class ElectricResistivity :  QuantityBase, IQuantity<ElectricResistivityUnit>, IEquatable<ElectricResistivity>, IComparable, IComparable<ElectricResistivity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new ElectricResistivity((QuantityValue)value, (ElectricResistivityUnit)unit);
#endif
        ...
        public ElectricResistivity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricResistivity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricResistivity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public ElectricResistivity(QuantityValue value, ElectricResistivityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public ElectricResistivity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<ElectricResistivityUnit> QuantityInfo => Info;
        ...
        /// <summary>Negate the <see cref="ElectricResistivity"/>.</summary>
        public new ElectricResistivity Negate()
        {
            return new ElectricResistivity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="ElectricResistivity"/> together</summary>
        public ElectricResistivity Add(ElectricResistivity other)
        {
            return new ElectricResistivity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="ElectricResistivity"/> from another</summary>
        public ElectricResistivity Subtract(ElectricResistivity other)
        {
            return new ElectricResistivity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="ElectricResistivity"/> by a constant</summary>
        public new ElectricResistivity Scale(double scaleFactor)
        {
            return new ElectricResistivity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="ElectricResistivity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((ElectricResistivity)other);

        /// <summary>Subtract one <see cref="ElectricResistivity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((ElectricResistivity)other);
        ...
        {
            if(other is ElectricResistivity otherElectricResistivity)
            {
                return Value.CompareTo(otherElectricResistivity.GetValueAs(this.Unit));
            }
        ...
        public override ElectricResistivity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<ElectricResistivityUnit> IQuantity<ElectricResistivityUnit>.ToUnit(ElectricResistivityUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<ElectricResistivityUnit> IQuantity<ElectricResistivityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<ElectricResistivityUnit>)ToUnit(unitSystem);
