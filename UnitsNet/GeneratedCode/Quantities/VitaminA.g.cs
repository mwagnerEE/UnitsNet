...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class VitaminA :  QuantityBase, IQuantity<VitaminAUnit>, IEquatable<VitaminA>, IComparable, IComparable<VitaminA>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new VitaminA((QuantityValue)value, (VitaminAUnit)unit);
#endif
        ...
        public VitaminA(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VitaminA(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VitaminA(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VitaminA(QuantityValue value, VitaminAUnit unit) : base(value, BaseDimensions)
        {
        ...
        public VitaminA(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<VitaminAUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) internationalunits;
        ...
        {
            return new VitaminA((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="VitaminA"/>.</summary>
        public new VitaminA Negate()
        {
            return new VitaminA(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="VitaminA"/> together</summary>
        public VitaminA Add(VitaminA other)
        {
            return new VitaminA(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="VitaminA"/> from another</summary>
        public VitaminA Subtract(VitaminA other)
        {
            return new VitaminA(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="VitaminA"/> by a constant</summary>
        public new VitaminA Scale(double scaleFactor)
        {
            return new VitaminA(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="VitaminA"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((VitaminA)other);

        /// <summary>Subtract one <see cref="VitaminA"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((VitaminA)other);
        ...
        {
            if(other is VitaminA otherVitaminA)
            {
                return Value.CompareTo(otherVitaminA.GetValueAs(this.Unit));
            }
        ...
        public override VitaminA ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<VitaminAUnit> IQuantity<VitaminAUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<VitaminAUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(VitaminAUnit unit)
        {
