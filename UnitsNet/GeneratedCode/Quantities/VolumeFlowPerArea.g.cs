...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class VolumeFlowPerArea :  QuantityBase, IQuantity<VolumeFlowPerAreaUnit>, IEquatable<VolumeFlowPerArea>, IComparable, IComparable<VolumeFlowPerArea>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new VolumeFlowPerArea((QuantityValue)value, (VolumeFlowPerAreaUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public VolumeFlowPerArea() : this(0, BaseUnit)
        {
        }
        ...
        public VolumeFlowPerArea(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumeFlowPerArea(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumeFlowPerArea(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new VolumeFlowPerArea(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumeFlowPerArea(QuantityValue value, VolumeFlowPerAreaUnit unit) : base(value, BaseDimensions)
        {
        ...
        public VolumeFlowPerArea(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<VolumeFlowPerAreaUnit> QuantityInfo => Info;
        ...
        /// <summary>Negate the <see cref="VolumeFlowPerArea"/>.</summary>
        public new VolumeFlowPerArea Negate()
        {
            return new VolumeFlowPerArea(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="VolumeFlowPerArea"/> together</summary>
        public VolumeFlowPerArea Add(VolumeFlowPerArea other)
        {
            return new VolumeFlowPerArea(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="VolumeFlowPerArea"/> from another</summary>
        public VolumeFlowPerArea Subtract(VolumeFlowPerArea other)
        {
            return new VolumeFlowPerArea(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="VolumeFlowPerArea"/> by a constant</summary>
        public new VolumeFlowPerArea Scale(double scaleFactor)
        {
            return new VolumeFlowPerArea(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="VolumeFlowPerArea"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((VolumeFlowPerArea)other);

        /// <summary>Subtract one <see cref="VolumeFlowPerArea"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((VolumeFlowPerArea)other);
        ...
        {
            if(other is VolumeFlowPerArea otherVolumeFlowPerArea)
            {
                return Value.CompareTo(otherVolumeFlowPerArea.GetValueAs(this.Unit));
            }
        ...
        public override VolumeFlowPerArea ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<VolumeFlowPerAreaUnit> IQuantity<VolumeFlowPerAreaUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<VolumeFlowPerAreaUnit>)ToUnit(unitSystem);
