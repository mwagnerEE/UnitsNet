...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class Permittivity :  QuantityBase, IQuantity<PermittivityUnit>, IEquatable<Permittivity>, IComparable, IComparable<Permittivity>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new Permittivity((QuantityValue)value, (PermittivityUnit)unit);
#endif
        ...
        public Permittivity(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Permittivity(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Permittivity(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public Permittivity(QuantityValue value, PermittivityUnit unit) : base(value, BaseDimensions)
        {
        ...
        public Permittivity(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<PermittivityUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) faradspermeter;
        ...
        {
            return new Permittivity((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="Permittivity"/>.</summary>
        public new Permittivity Negate()
        {
            return new Permittivity(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="Permittivity"/> together</summary>
        public Permittivity Add(Permittivity other)
        {
            return new Permittivity(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="Permittivity"/> from another</summary>
        public Permittivity Subtract(Permittivity other)
        {
            return new Permittivity(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="Permittivity"/> by a constant</summary>
        public new Permittivity Scale(double scaleFactor)
        {
            return new Permittivity(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="Permittivity"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((Permittivity)other);

        /// <summary>Subtract one <see cref="Permittivity"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((Permittivity)other);
        ...
        {
            if(other is Permittivity otherPermittivity)
            {
                return Value.CompareTo(otherPermittivity.GetValueAs(this.Unit));
            }
        ...
        public override Permittivity ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<PermittivityUnit> IQuantity<PermittivityUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<PermittivityUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(PermittivityUnit unit)
        {
