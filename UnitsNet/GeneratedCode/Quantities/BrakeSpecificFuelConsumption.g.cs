...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrakeSpecificFuelConsumption :  QuantityBase, IQuantity<BrakeSpecificFuelConsumptionUnit>, IEquatable<BrakeSpecificFuelConsumption>, IComparable, IComparable<BrakeSpecificFuelConsumption>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new BrakeSpecificFuelConsumption((QuantityValue)value, (BrakeSpecificFuelConsumptionUnit)unit);
#endif
        ...
        public BrakeSpecificFuelConsumption(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public BrakeSpecificFuelConsumption(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public BrakeSpecificFuelConsumption(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public BrakeSpecificFuelConsumption(QuantityValue value, BrakeSpecificFuelConsumptionUnit unit) : base(value, BaseDimensions)
        {
        ...
        public BrakeSpecificFuelConsumption(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<BrakeSpecificFuelConsumptionUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) gramsperkilowatthour;
        ...
        {
            QuantityValue value = (QuantityValue) kilogramsperjoule;
        ...
        {
            QuantityValue value = (QuantityValue) poundspermechanicalhorsepowerhour;
        ...
        {
            return new BrakeSpecificFuelConsumption((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="BrakeSpecificFuelConsumption"/>.</summary>
        public new BrakeSpecificFuelConsumption Negate()
        {
            return new BrakeSpecificFuelConsumption(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="BrakeSpecificFuelConsumption"/> together</summary>
        public BrakeSpecificFuelConsumption Add(BrakeSpecificFuelConsumption other)
        {
            return new BrakeSpecificFuelConsumption(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="BrakeSpecificFuelConsumption"/> from another</summary>
        public BrakeSpecificFuelConsumption Subtract(BrakeSpecificFuelConsumption other)
        {
            return new BrakeSpecificFuelConsumption(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="BrakeSpecificFuelConsumption"/> by a constant</summary>
        public new BrakeSpecificFuelConsumption Scale(double scaleFactor)
        {
            return new BrakeSpecificFuelConsumption(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="BrakeSpecificFuelConsumption"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((BrakeSpecificFuelConsumption)other);

        /// <summary>Subtract one <see cref="BrakeSpecificFuelConsumption"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((BrakeSpecificFuelConsumption)other);
        ...
        {
            if(other is BrakeSpecificFuelConsumption otherBrakeSpecificFuelConsumption)
            {
                return Value.CompareTo(otherBrakeSpecificFuelConsumption.GetValueAs(this.Unit));
            }
        ...
        public override BrakeSpecificFuelConsumption ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<BrakeSpecificFuelConsumptionUnit> IQuantity<BrakeSpecificFuelConsumptionUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<BrakeSpecificFuelConsumptionUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(BrakeSpecificFuelConsumptionUnit unit)
        {
