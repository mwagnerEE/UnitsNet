...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial class VolumeConcentration :  QuantityBase, IQuantity<VolumeConcentrationUnit>, IEquatable<VolumeConcentration>, IComparable, IComparable<VolumeConcentration>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new VolumeConcentration((QuantityValue)value, (VolumeConcentrationUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public VolumeConcentration() : this(0, BaseUnit)
        {
        }
        ...
        public VolumeConcentration(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumeConcentration(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumeConcentration(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new VolumeConcentration(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public VolumeConcentration(QuantityValue value, VolumeConcentrationUnit unit) : base(value, BaseDimensions)
        {
        ...
        public VolumeConcentration(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<VolumeConcentrationUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) centilitersperliter;
        ...
        {
            QuantityValue value = (QuantityValue) centiliterspermililiter;
        ...
        {
            QuantityValue value = (QuantityValue) decilitersperliter;
        ...
        {
            QuantityValue value = (QuantityValue) deciliterspermililiter;
        ...
        {
            QuantityValue value = (QuantityValue) litersperliter;
        ...
        {
            QuantityValue value = (QuantityValue) literspermililiter;
        ...
        {
            QuantityValue value = (QuantityValue) microlitersperliter;
        ...
        {
            QuantityValue value = (QuantityValue) microliterspermililiter;
        ...
        {
            QuantityValue value = (QuantityValue) millilitersperliter;
        ...
        {
            QuantityValue value = (QuantityValue) milliliterspermililiter;
        ...
        {
            QuantityValue value = (QuantityValue) nanolitersperliter;
        ...
        {
            QuantityValue value = (QuantityValue) nanoliterspermililiter;
        ...
        {
            QuantityValue value = (QuantityValue) picolitersperliter;
        ...
        {
            QuantityValue value = (QuantityValue) picoliterspermililiter;
        ...
        {
            return new VolumeConcentration((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="VolumeConcentration"/>.</summary>
        public new VolumeConcentration Negate()
        {
            return new VolumeConcentration(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="VolumeConcentration"/> together</summary>
        public VolumeConcentration Add(VolumeConcentration other)
        {
            return new VolumeConcentration(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="VolumeConcentration"/> from another</summary>
        public VolumeConcentration Subtract(VolumeConcentration other)
        {
            return new VolumeConcentration(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="VolumeConcentration"/> by a constant</summary>
        public new VolumeConcentration Scale(double scaleFactor)
        {
            return new VolumeConcentration(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="VolumeConcentration"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((VolumeConcentration)other);

        /// <summary>Subtract one <see cref="VolumeConcentration"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((VolumeConcentration)other);
        ...
        {
            if(other is VolumeConcentration otherVolumeConcentration)
            {
                return Value.CompareTo(otherVolumeConcentration.GetValueAs(this.Unit));
            }
        ...
        public override VolumeConcentration ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<VolumeConcentrationUnit> IQuantity<VolumeConcentrationUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<VolumeConcentrationUnit>)ToUnit(unitSystem);
