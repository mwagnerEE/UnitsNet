...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemperatureDelta :  QuantityBase, IQuantity<TemperatureDeltaUnit>, IEquatable<TemperatureDelta>, IComparable, IComparable<TemperatureDelta>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new TemperatureDelta((QuantityValue)value, (TemperatureDeltaUnit)unit);
#endif
        ...
        public TemperatureDelta(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureDelta(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureDelta(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public TemperatureDelta(QuantityValue value, TemperatureDeltaUnit unit) : base(value, BaseDimensions)
        {
        ...
        public TemperatureDelta(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<TemperatureDeltaUnit> QuantityInfo => Info;
        ...
        {
            QuantityValue value = (QuantityValue) degreescelsius;
        ...
        {
            QuantityValue value = (QuantityValue) degreesdelisle;
        ...
        {
            QuantityValue value = (QuantityValue) degreesfahrenheit;
        ...
        {
            QuantityValue value = (QuantityValue) degreesnewton;
        ...
        {
            QuantityValue value = (QuantityValue) degreesrankine;
        ...
        {
            QuantityValue value = (QuantityValue) degreesreaumur;
        ...
        {
            QuantityValue value = (QuantityValue) degreesroemer;
        ...
        {
            QuantityValue value = (QuantityValue) kelvins;
        ...
        {
            QuantityValue value = (QuantityValue) millidegreescelsius;
        ...
        {
            return new TemperatureDelta((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="TemperatureDelta"/>.</summary>
        public new TemperatureDelta Negate()
        {
            return new TemperatureDelta(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="TemperatureDelta"/> together</summary>
        public TemperatureDelta Add(TemperatureDelta other)
        {
            return new TemperatureDelta(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="TemperatureDelta"/> from another</summary>
        public TemperatureDelta Subtract(TemperatureDelta other)
        {
            return new TemperatureDelta(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="TemperatureDelta"/> by a constant</summary>
        public new TemperatureDelta Scale(double scaleFactor)
        {
            return new TemperatureDelta(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="TemperatureDelta"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((TemperatureDelta)other);

        /// <summary>Subtract one <see cref="TemperatureDelta"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((TemperatureDelta)other);
        ...
        {
            if(other is TemperatureDelta otherTemperatureDelta)
            {
                return Value.CompareTo(otherTemperatureDelta.GetValueAs(this.Unit));
            }
        ...
        IQuantity IQuantity.ToUnit(Enum unit, UnitConverter unitConverter)
        {
            ...
            return ToUnit(unitAsTemperatureDeltaUnit, unitConverter);
        }

        /// <inheritdoc cref="IQuantity.ToUnit(UnitSystem)"/>
#if NET5_0_OR_GREATER
        public override TemperatureDelta ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<TemperatureDeltaUnit> IQuantity<TemperatureDeltaUnit>.ToUnit(TemperatureDeltaUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<TemperatureDeltaUnit> IQuantity<TemperatureDeltaUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<TemperatureDeltaUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(TemperatureDeltaUnit unit)
        {
