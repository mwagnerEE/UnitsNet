...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class HeatTransferCoefficient :  QuantityBase, IQuantity<HeatTransferCoefficientUnit>, IEquatable<HeatTransferCoefficient>, IComparable, IComparable<HeatTransferCoefficient>, IConvertible, IArithmetic, IFormattable
    {
        /// <summary>
        ...
        public static IQuantity Construct(QuantityValue value, Enum unit) => new HeatTransferCoefficient((QuantityValue)value, (HeatTransferCoefficientUnit)unit);
#endif

        /// <summary>
        ///     Creates the quantity with the a value of zero.
        /// </summary>
        public HeatTransferCoefficient() : this(0, BaseUnit)
        {
        }
        ...
        public HeatTransferCoefficient(QuantityValue value) : this(value, BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public HeatTransferCoefficient(double value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        /// <param name="value">The numeric value to construct this quantity with.</param>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public HeatTransferCoefficient(Complex value) : this(new QuantityValue(value), BaseUnit)
        {
        }
        ...
        {
            return new HeatTransferCoefficient(value);
        }
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public HeatTransferCoefficient(QuantityValue value, HeatTransferCoefficientUnit unit) : base(value, BaseDimensions)
        {
        ...
        public HeatTransferCoefficient(QuantityValue value, UnitSystem unitSystem) : base(value, BaseDimensions)
        {
        ...
        /// <inheritdoc />
        public new QuantityInfo<HeatTransferCoefficientUnit> QuantityInfo => Info;
        ...
        /// </summary>
        public QuantityValue BtusPerSquareFootDegreeFahrenheit => As(HeatTransferCoefficientUnit.BtuPerSquareFootDegreeFahrenheit);
        ...
        {
            QuantityValue value = (QuantityValue) btuspersquarefootdegreefahrenheit;
        ...
        {
            QuantityValue value = (QuantityValue) wattspersquaremetercelsius;
        ...
        {
            QuantityValue value = (QuantityValue) wattspersquaremeterkelvin;
        ...
        {
            return new HeatTransferCoefficient((QuantityValue)value, fromUnit);
        }
        ...
        /// <summary>Negate the <see cref="HeatTransferCoefficient"/>.</summary>
        public new HeatTransferCoefficient Negate()
        {
            return new HeatTransferCoefficient(-this.Value, this.Unit);
        }

        /// <summary>Add two <see cref="HeatTransferCoefficient"/> together</summary>
        public HeatTransferCoefficient Add(HeatTransferCoefficient other)
        {
            return new HeatTransferCoefficient(this.Value + other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Subtract one <see cref="HeatTransferCoefficient"/> from another</summary>
        public HeatTransferCoefficient Subtract(HeatTransferCoefficient other)
        {
            return new HeatTransferCoefficient(this.Value - other.GetValueAs(this.Unit), this.Unit);
        }

        /// <summary>Scale the <see cref="HeatTransferCoefficient"/> by a constant</summary>
        public new HeatTransferCoefficient Scale(double scaleFactor)
        {
            return new HeatTransferCoefficient(scaleFactor * this.Value, this.Unit);
        }
        ...
        /// <summary>Add two <see cref="HeatTransferCoefficient"/> together</summary>
        IQuantity IArithmetic.Add(IQuantity other) => Add((HeatTransferCoefficient)other);

        /// <summary>Subtract one <see cref="HeatTransferCoefficient"/> from another</summary>
        IQuantity IArithmetic.Subtract(IQuantity other) => Subtract((HeatTransferCoefficient)other);
        ...
        {
            if(other is HeatTransferCoefficient otherHeatTransferCoefficient)
            {
                return Value.CompareTo(otherHeatTransferCoefficient.GetValueAs(this.Unit));
            }
        ...
        public override HeatTransferCoefficient ToUnit(UnitSystem unitSystem)
#else
        ...
        /// <inheritdoc />
        IQuantity<HeatTransferCoefficientUnit> IQuantity<HeatTransferCoefficientUnit>.ToUnit(HeatTransferCoefficientUnit unit, UnitConverter unitConverter) => ToUnit(unit, unitConverter);

        /// <inheritdoc />
        IQuantity<HeatTransferCoefficientUnit> IQuantity<HeatTransferCoefficientUnit>.ToUnit(UnitSystem unitSystem) => (IQuantity<HeatTransferCoefficientUnit>)ToUnit(unitSystem);

        private QuantityValue GetValueAs(HeatTransferCoefficientUnit unit)
        {
