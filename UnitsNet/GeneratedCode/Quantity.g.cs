...
namespace UnitsNet
{
    ...
    public static partial class Quantity
    {
        ...
        public static readonly IDictionary<string, QuantityInfo> ByName = new Dictionary<string, QuantityInfo>
        {
            ...
            { "ElectricLinearResistivity", ElectricLinearResistivity.Info },
        ...
        public static IQuantity FromQuantityType(QuantityType quantityType, QuantityValue value)
        {
            return quantityType switch
            {
                ...
                QuantityType.ElectricLinearResistivity => ElectricLinearResistivity.From(value, ElectricLinearResistivity.BaseUnit),
        ...
        public static IQuantity FromQuantityInfo(QuantityInfo quantityInfo, QuantityValue value)
        {
            return quantityInfo.Name switch
            {
                ...
                "ElectricLinearResistivity" => ElectricLinearResistivity.From(value, ElectricLinearResistivity.BaseUnit),
        ...
        public static bool TryFrom(QuantityValue value, Enum unit, out IQuantity? quantity)
        {
            switch (unit)
            {
                ...
                case ElectricInductanceUnit electricInductanceUnit:
                    ...
                    return true;
                case ElectricLinearResistivityUnit electricLinearResistivityUnit:
                    quantity = ElectricLinearResistivity.From(value, electricLinearResistivityUnit);
                    return true;
        ...
        private static List<(Dimensions, BaseUnitQuantityConstructor)> BaseUnitsToQuantityConstructor = new List<(Dimensions, BaseUnitQuantityConstructor)>()
        {
                ...
                ( Acceleration.BaseDimensions, Acceleration.FromBaseUnits),
                ( AmountOfSubstance.BaseDimensions, AmountOfSubstance.FromBaseUnits),
                ( AmplitudeRatio.BaseDimensions, AmplitudeRatio.FromBaseUnits),
                ( Angle.BaseDimensions, Angle.FromBaseUnits),
                ( ApparentEnergy.BaseDimensions, ApparentEnergy.FromBaseUnits),
                ( ApparentPower.BaseDimensions, ApparentPower.FromBaseUnits),
                ( Area.BaseDimensions, Area.FromBaseUnits),
                ( AreaDensity.BaseDimensions, AreaDensity.FromBaseUnits),
                ( AreaMomentOfInertia.BaseDimensions, AreaMomentOfInertia.FromBaseUnits),
                ( BitRate.BaseDimensions, BitRate.FromBaseUnits),
                ( BrakeSpecificFuelConsumption.BaseDimensions, BrakeSpecificFuelConsumption.FromBaseUnits),
                ( Capacitance.BaseDimensions, Capacitance.FromBaseUnits),
                ( CoefficientOfThermalExpansion.BaseDimensions, CoefficientOfThermalExpansion.FromBaseUnits),
                ( Density.BaseDimensions, Density.FromBaseUnits),
                ( Duration.BaseDimensions, Duration.FromBaseUnits),
                ( DynamicViscosity.BaseDimensions, DynamicViscosity.FromBaseUnits),
                ( ElectricAdmittance.BaseDimensions, ElectricAdmittance.FromBaseUnits),
                ( ElectricCharge.BaseDimensions, ElectricCharge.FromBaseUnits),
                ( ElectricChargeDensity.BaseDimensions, ElectricChargeDensity.FromBaseUnits),
                ( ElectricConductance.BaseDimensions, ElectricConductance.FromBaseUnits),
                ( ElectricConductivity.BaseDimensions, ElectricConductivity.FromBaseUnits),
                ( ElectricCurrent.BaseDimensions, ElectricCurrent.FromBaseUnits),
                ( ElectricCurrentDensity.BaseDimensions, ElectricCurrentDensity.FromBaseUnits),
                ( ElectricCurrentGradient.BaseDimensions, ElectricCurrentGradient.FromBaseUnits),
                ( ElectricField.BaseDimensions, ElectricField.FromBaseUnits),
                ( ElectricInductance.BaseDimensions, ElectricInductance.FromBaseUnits),
                ( ElectricLinearResistivity.BaseDimensions, ElectricLinearResistivity.FromBaseUnits),
                ( ElectricPotential.BaseDimensions, ElectricPotential.FromBaseUnits),
                ( ElectricPotentialAc.BaseDimensions, ElectricPotentialAc.FromBaseUnits),
                ( ElectricPotentialChangeRate.BaseDimensions, ElectricPotentialChangeRate.FromBaseUnits),
                ( ElectricPotentialDc.BaseDimensions, ElectricPotentialDc.FromBaseUnits),
                ( ElectricResistance.BaseDimensions, ElectricResistance.FromBaseUnits),
                ( ElectricResistivity.BaseDimensions, ElectricResistivity.FromBaseUnits),
                ( ElectricSurfaceChargeDensity.BaseDimensions, ElectricSurfaceChargeDensity.FromBaseUnits),
                ( Energy.BaseDimensions, Energy.FromBaseUnits),
                ( Entropy.BaseDimensions, Entropy.FromBaseUnits),
                ( Force.BaseDimensions, Force.FromBaseUnits),
                ( ForceChangeRate.BaseDimensions, ForceChangeRate.FromBaseUnits),
                ( ForcePerLength.BaseDimensions, ForcePerLength.FromBaseUnits),
                ( Frequency.BaseDimensions, Frequency.FromBaseUnits),
                ( FuelEfficiency.BaseDimensions, FuelEfficiency.FromBaseUnits),
                ( HeatFlux.BaseDimensions, HeatFlux.FromBaseUnits),
                ( HeatTransferCoefficient.BaseDimensions, HeatTransferCoefficient.FromBaseUnits),
                ( Illuminance.BaseDimensions, Illuminance.FromBaseUnits),
                ( Information.BaseDimensions, Information.FromBaseUnits),
                ( Irradiance.BaseDimensions, Irradiance.FromBaseUnits),
                ( Irradiation.BaseDimensions, Irradiation.FromBaseUnits),
                ( KinematicViscosity.BaseDimensions, KinematicViscosity.FromBaseUnits),
                ( LapseRate.BaseDimensions, LapseRate.FromBaseUnits),
                ( Length.BaseDimensions, Length.FromBaseUnits),
                ( Level.BaseDimensions, Level.FromBaseUnits),
                ( LinearDensity.BaseDimensions, LinearDensity.FromBaseUnits),
                ( LinearPowerDensity.BaseDimensions, LinearPowerDensity.FromBaseUnits),
                ( Luminosity.BaseDimensions, Luminosity.FromBaseUnits),
                ( LuminousFlux.BaseDimensions, LuminousFlux.FromBaseUnits),
                ( LuminousIntensity.BaseDimensions, LuminousIntensity.FromBaseUnits),
                ( MagneticField.BaseDimensions, MagneticField.FromBaseUnits),
                ( MagneticFlux.BaseDimensions, MagneticFlux.FromBaseUnits),
                ( Magnetization.BaseDimensions, Magnetization.FromBaseUnits),
                ( Mass.BaseDimensions, Mass.FromBaseUnits),
                ( MassConcentration.BaseDimensions, MassConcentration.FromBaseUnits),
                ( MassFlow.BaseDimensions, MassFlow.FromBaseUnits),
                ( MassFlux.BaseDimensions, MassFlux.FromBaseUnits),
                ( MassFraction.BaseDimensions, MassFraction.FromBaseUnits),
                ( MassMomentOfInertia.BaseDimensions, MassMomentOfInertia.FromBaseUnits),
                ( MolarEnergy.BaseDimensions, MolarEnergy.FromBaseUnits),
                ( MolarEntropy.BaseDimensions, MolarEntropy.FromBaseUnits),
                ( Molarity.BaseDimensions, Molarity.FromBaseUnits),
                ( MolarMass.BaseDimensions, MolarMass.FromBaseUnits),
                ( Permeability.BaseDimensions, Permeability.FromBaseUnits),
                ( Permittivity.BaseDimensions, Permittivity.FromBaseUnits),
                ( Power.BaseDimensions, Power.FromBaseUnits),
                ( PowerDensity.BaseDimensions, PowerDensity.FromBaseUnits),
                ( PowerRatio.BaseDimensions, PowerRatio.FromBaseUnits),
                ( Pressure.BaseDimensions, Pressure.FromBaseUnits),
                ( PressureChangeRate.BaseDimensions, PressureChangeRate.FromBaseUnits),
                ( Ratio.BaseDimensions, Ratio.FromBaseUnits),
                ( RatioChangeRate.BaseDimensions, RatioChangeRate.FromBaseUnits),
                ( ReactiveEnergy.BaseDimensions, ReactiveEnergy.FromBaseUnits),
                ( ReactivePower.BaseDimensions, ReactivePower.FromBaseUnits),
                ( ReciprocalArea.BaseDimensions, ReciprocalArea.FromBaseUnits),
                ( ReciprocalLength.BaseDimensions, ReciprocalLength.FromBaseUnits),
                ( RelativeHumidity.BaseDimensions, RelativeHumidity.FromBaseUnits),
                ( RotationalAcceleration.BaseDimensions, RotationalAcceleration.FromBaseUnits),
                ( RotationalSpeed.BaseDimensions, RotationalSpeed.FromBaseUnits),
                ( RotationalStiffness.BaseDimensions, RotationalStiffness.FromBaseUnits),
                ( RotationalStiffnessPerLength.BaseDimensions, RotationalStiffnessPerLength.FromBaseUnits),
                ( Scalar.BaseDimensions, Scalar.FromBaseUnits),
                ( SolidAngle.BaseDimensions, SolidAngle.FromBaseUnits),
                ( SpecificEnergy.BaseDimensions, SpecificEnergy.FromBaseUnits),
                ( SpecificEntropy.BaseDimensions, SpecificEntropy.FromBaseUnits),
                ( SpecificFuelConsumption.BaseDimensions, SpecificFuelConsumption.FromBaseUnits),
                ( SpecificVolume.BaseDimensions, SpecificVolume.FromBaseUnits),
                ( SpecificWeight.BaseDimensions, SpecificWeight.FromBaseUnits),
                ( Speed.BaseDimensions, Speed.FromBaseUnits),
                ( StandardVolumeFlow.BaseDimensions, StandardVolumeFlow.FromBaseUnits),
                ( Temperature.BaseDimensions, Temperature.FromBaseUnits),
                ( TemperatureChangeRate.BaseDimensions, TemperatureChangeRate.FromBaseUnits),
                ( TemperatureDelta.BaseDimensions, TemperatureDelta.FromBaseUnits),
                ( TemperatureGradient.BaseDimensions, TemperatureGradient.FromBaseUnits),
                ( ThermalConductivity.BaseDimensions, ThermalConductivity.FromBaseUnits),
                ( ThermalResistance.BaseDimensions, ThermalResistance.FromBaseUnits),
                ( Torque.BaseDimensions, Torque.FromBaseUnits),
                ( TorquePerLength.BaseDimensions, TorquePerLength.FromBaseUnits),
                ( Turbidity.BaseDimensions, Turbidity.FromBaseUnits),
                ( VitaminA.BaseDimensions, VitaminA.FromBaseUnits),
                ( Volume.BaseDimensions, Volume.FromBaseUnits),
                ( VolumeConcentration.BaseDimensions, VolumeConcentration.FromBaseUnits),
                ( VolumeFlow.BaseDimensions, VolumeFlow.FromBaseUnits),
                ( VolumeFlowPerArea.BaseDimensions, VolumeFlowPerArea.FromBaseUnits),
                ( VolumePerLength.BaseDimensions, VolumePerLength.FromBaseUnits),
                ( VolumetricHeatCapacity.BaseDimensions, VolumetricHeatCapacity.FromBaseUnits),
                ( WarpingMomentOfInertia.BaseDimensions, WarpingMomentOfInertia.FromBaseUnits),
        };
                ...
                public static bool TryParse(IFormatProvider? formatProvider, Type quantityType, string quantityString, out IQuantity? quantity)
        {
            ...
            return quantityType switch
            {
                ...
                Type _ when quantityType == typeof(ElectricLinearResistivity) => parser.TryParse<ElectricLinearResistivity, ElectricLinearResistivityUnit>(quantityString, formatProvider, ElectricLinearResistivity.From, out quantity),
        ...
        internal static IEnumerable<Type> GetQuantityTypes()
        {
            ...
            yield return typeof(ElectricLinearResistivity);
