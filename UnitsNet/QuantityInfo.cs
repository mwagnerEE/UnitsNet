...
namespace UnitsNet
{
    ...
    public class QuantityInfo
    {
        ...
        /// <param name="dimensions">The base dimensions of the quantity.</param>
        ...
        public QuantityInfo([NotNull] string name, Type unitType, [NotNull] UnitInfo[] unitInfos, [NotNull] Enum baseUnit, [NotNull] IQuantity zero, [NotNull] Dimensions dimensions)
        {
        ...
        /// <summary>
        ///     The <see cref="Dimensions" /> for a quantity.
        /// </summary>
        ...
        where TUnit : Enum
    {
        ...
        /// <inheritdoc />
        public QuantityInfo(string name, UnitInfo<TUnit>[] unitInfos, TUnit baseUnit, IQuantity<TUnit> zero, Dimensions dimensions)
            : base(name, typeof(TUnit), unitInfos.ToArray<UnitInfo>(), baseUnit, zero, dimensions)
        {
            Zero = zero;
            UnitInfos = unitInfos ?? throw new ArgumentNullException(nameof(unitInfos));
            BaseUnitInfo = UnitInfos.First(unitInfo => unitInfo.Value.Equals(baseUnit));
