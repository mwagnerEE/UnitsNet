...
namespace UnitsNet
{
    ...
    public static class Comparison
    {
        ...
        /// <param name="comparisonType">Whether the tolerance is absolute or relative.</param>
        /// <returns></returns>
        public static bool Equals(QuantityValue referenceValue, QuantityValue otherValue, double tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
                throw new ArgumentOutOfRangeException("tolerance", "Tolerance must be greater than or equal to 0");
        ...
        /// <param name="tolerance">The relative tolerance. Must be greater than or equal to 0.</param>
        /// <returns>True if the two values are equal within the given relative tolerance, otherwise false.</returns>
        public static bool EqualsRelative(QuantityValue referenceValue, QuantityValue otherValue, double tolerance)
        {
            if (tolerance < 0)
                throw new ArgumentOutOfRangeException("tolerance", "Tolerance must be greater than or equal to 0");

            var maxVariation = (referenceValue * tolerance).Magnitude;
            return (referenceValue - otherValue).Magnitude <= maxVariation;
        }
        ...
        /// <param name="tolerance">The absolute tolerance. Must be greater than or equal to 0.</param>
        /// <returns>True if the two values are equal within the given absolute tolerance, otherwise false.</returns>
        public static bool EqualsAbsolute(QuantityValue value1, QuantityValue value2, double tolerance)
        {
            if (tolerance < 0)
                throw new ArgumentOutOfRangeException("tolerance", "Tolerance must be greater than or equal to 0");
