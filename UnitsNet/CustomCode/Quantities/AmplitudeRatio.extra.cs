...
namespace UnitsNet
{
    public partial class AmplitudeRatio
    {
        ...
        public AmplitudeRatio(ElectricPotential voltage)
            : this(GetConstructorValue(voltage))
        {
            _unit = AmplitudeRatioUnit.DecibelVolt;
        }

        private static QuantityValue GetConstructorValue(ElectricPotential voltage)
        {
            if (voltage.Volts <= 0)
            ...
            return 20 * QuantityValue.Log10(voltage.Volts / 1);
        }
        ...
        {
            // E(V) = 1V * 10^(E(dBV)/20)
            return ElectricPotential.FromVolts(QuantityValue.Pow(10, DecibelVolts / 20));
        }
        ...
        public PowerRatio ToPowerRatio(ElectricResistance impedance)
        {
            ...
            return PowerRatio.FromDecibelWatts(DecibelVolts - 10 * QuantityValue.Log10(impedance.Ohms / 1));
        }
