...
namespace UnitsNet.CustomCode.Wrappers
{
    ...
    public struct ReferencePressure
    {
        ...
        /// <summary>
        ///     Converts <see cref="IQuantity.Value" /> to <see cref="double" /> at <see cref="PressureReference" />
        /// </summary>
        /// <param name="reference">The <see cref="PressureReference" /> to convert <see cref="ReferencePressure" /> to.</param>
        ...
        private double AsBaseNumericType(PressureReference reference)
        {
            ...
            switch (reference)
            {
                ...
                case PressureReference.Gauge: return baseReferenceValue - AtmosphericPressure.ToUnit(Pressure.Unit).Value.Real;
                case PressureReference.Vacuum: return AtmosphericPressure.ToUnit(Pressure.Unit).Value.Real - negatingValue * baseReferenceValue;
                default:
        ...
        /// <summary>
        ///     Converts <see cref="IQuantity.Value" /> at <see cref="Reference" /> to <see cref="double" /> at
        ...
        private double AsBaseReference()
        {
            switch (Reference)
            {
                ...
                case PressureReference.Gauge:
                {
                    ...
                    return AtmosphericPressure.ToUnit(Pressure.Unit).Value.Real + Pressure.Value.Real;
                }
