...
namespace UnitsNet.Benchmark
{
    ...
    public class UnitsNetBenchmarks
    {
        ...
        public QuantityValue ToProperty() => length.Centimeters;

        [Benchmark]
        [BenchmarkCategory("Transformation, Value")]
        public QuantityValue As() => length.As(LengthUnit.Centimeter);

        [Benchmark]
        [BenchmarkCategory("Transformation, Value")]
        public QuantityValue As_SI() => length.As(UnitSystem.SI);
        ...
        [Benchmark]
        [BenchmarkCategory("Transformation, Quantity")]
        public Length ToUnit_SI() => (Length)length.ToUnit(UnitSystem.SI);
        ...
        [Benchmark]
        [BenchmarkCategory("Transformation, Value")]
        public QuantityValue IQuantity_As() => lengthIQuantity.As(LengthUnit.Centimeter);

        [Benchmark]
        [BenchmarkCategory("Transformation, Value")]
        public QuantityValue IQuantity_As_SI() => lengthIQuantity.As(UnitSystem.SI);
