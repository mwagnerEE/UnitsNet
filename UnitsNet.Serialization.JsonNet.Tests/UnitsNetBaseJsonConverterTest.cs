...
namespace UnitsNet.Serialization.JsonNet.Tests
{
    public sealed class UnitsNetBaseJsonConverterTest
    {
        ...
        private class TestConverter : UnitsNetBaseJsonConverter<string>
        {
            ...
            public (string Unit, QuantityValue Value) Test_ConvertDoubleIQuantity(IQuantity value)
            {
                var result = ConvertIQuantity(value);
                return (result.Unit, result.Value);
            }

            public (string Unit, QuantityValue Value) Test_ConvertDecimalIQuantity(IQuantity value)
            {
                var result = ConvertIQuantity(value);
            ...
            public (string Unit, QuantityValue Value)? Test_ReadDoubleValueUnit(JToken jsonToken)
            {
